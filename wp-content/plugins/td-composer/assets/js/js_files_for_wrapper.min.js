...
jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/do_job","tmp_jobId="+e.jobId+"&tmp_blockUid="+e.blockUid+"&uuid="+tdcJobManager._getUniqueID()+"&post_id="+window.tdcPostSettings.postId),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},cache:!1,data:e,dataType:"json",statusCode:{404:function(){console.log("tdcJobManager.addJob - ERROR: 404 not found")},500:function(){console.log("tdcJobManager.addJob - ERROR: 500 server error")}},
success:function(b,d,a){null===b?f.error(e,"tdcJobManager.addJob - ERROR: Empty response received from server"):(!0===tdcJobManager._isJobCallbackReplyValid(f.blockUid,b.jobId)?f.success_callback(b):tdcDebug.log("tdcJobManager.addJob - dropped job :) (probably it's older than the last timestamp)"),tdcDebug.groupEnd())},error:function(b,d,a){f.error_callback(e,"tdcJobManager.addJob - Error callback - textStatus: "+d+" errorThrown: "+a);tdcDebug.groupEnd()}})},_isJobCallbackReplyValid:function(f,e){return"undefined"===
...
(function(f,e){tdcAdminWrapperUI={$placeholder:e,$helper:e,_helperClass:"",$recycle:e,_initialized:!1,init:function(){tdcAdminWrapperUI._tdcJqObjElements=f(".tdc-sidebar-elements");tdcAdminWrapperUI.helperId="tdc-dragged-helper";tdcAdminWrapperUI.placeholderId="tdc-placeholder";tdcAdminWrapperUI.maskId="tdc-mask";tdcAdminWrapperUI.$helper=f('<div id="'+tdcAdminWrapperUI.helperId+'"></div>');tdcAdminWrapperUI.$placeholder=f('<span id="'+tdcAdminWrapperUI.placeholderId+'"></span>');f("body").append(tdcAdminWrapperUI.$helper);
f("body").append(tdcAdminWrapperUI.$placeholder);f(".tdc-save-page").click(function(b){f(this).hasClass("tdc-saving-loader")||(f(this).addClass("tdc-saving-loader"),tdcSavePost.save())})},setHelperClass:function(b){tdcAdminWrapperUI._helperClass!==b&&(tdcAdminWrapperUI._helperClass=b,tdcAdminWrapperUI.$helper.addClass(b))},getHelperClass:function(){return tdcAdminWrapperUI._helperClass},clearHelperClass:function(){tdcAdminWrapperUI._helperClass=""}};tdcAdminWrapperUI.init()})(jQuery);var tdcOperationUI;
(function(f,e,b,d){tdcOperationUI={iframeContents:d,_draggedElement:{$element:d},_currentElementOver:{$element:d},_emptyElementClass:"tdc-element-empty",_isPlaceholderVisible:!1,_intervalUpdateInfoHelper:d,_isMenuDeactivated:!1,init:function(a,c){window.previousMouseClientX=0;window.previousMouseClientY=0;tdcOperationUI.iframeContents=a;tdcRowUI.init(tdcOperationUI.iframeContents);tdcColumnUI.init(tdcOperationUI.iframeContents);tdcInnerRowUI.init(tdcOperationUI.iframeContents);tdcInnerColumnUI.init(tdcOperationUI.iframeContents);
...
showHelper:function(a){var c=tdcAdminWrapperUI.$helper,g=tdcOperationUI.getDraggedElement();if(b.isUndefined(g))tdcOperationUI.hideHelper(),tdcRecycleUI.hide(),tdcOperationUI.setLiveIframeCss("tdc-active-helper",!0);else{var d=0;!0!==tdcMain.getSidebarInline()||!1!==tdcMain.getSidebarHidden()||f(a.target).closest("#tdc-sidebar").length||(d=tdcSidebar.$_sidebar.width());var h=tdcAdminIFrameUI.getLiveIframe().width(),e=0;window.innerWidth!==h&&(e=(window.innerWidth-h)/2,!0===tdcMain.getSidebarInline()&&
!1===tdcMain.getSidebarHidden()&&(e-=tdcSidebar.$_sidebar.width()/2));f(a.target).closest("#tdc-sidebar").length?e=0:f(a.target).closest("#tdc-live-iframe-wrapper").length&&(e=0,tdcMain.getSidebarInline()&&(e=-tdcSidebar.$_sidebar.width()));c.css({left:a.clientX-30+d+e,top:a.clientY-22});c.show();tdcOperationUI.deactivateMenu();tdcOperationUI.setLiveIframeCss("tdc-active-helper");a=g.data("shortcodeName");b.isUndefined(a)&&(g=g.data("model_id"),a=tdcIFrameData.getModel(g).get("tag"));b.isUndefined(a)||
tdcAdminWrapperUI.setHelperClass("tdc-element-ico tdc-ico-"+a);tdcRecycleUI.show()}},hideHelper:function(){tdcAdminWrapperUI.clearHelperClass();tdcAdminWrapperUI.$helper.hide();tdcAdminWrapperUI.$helper.removeClass();tdcOperationUI.activateMenu()},setLiveIframeCss:function(a,c){var g=tdcAdminIFrameUI.getLiveIframe();b.isUndefined(c)?g.contents().find("body").addClass(a):g.contents().find("body").removeClass(a)},activateMenu:function(){if(tdcOperationUI._isMenuDeactivated){var a=tdcAdminIFrameUI.getLiveIframe().contents().find(".td-header-wrap");
a.length&&a.removeClass("tdc-inactive-menu");tdcOperationUI._isMenuDeactivated=!1}},deactivateMenu:function(){if(!tdcOperationUI._isMenuDeactivated){var a=tdcAdminIFrameUI.getLiveIframe().contents().find(".td-header-wrap");a.length&&a.addClass("tdc-inactive-menu");tdcOperationUI._isMenuDeactivated=!0}},updateInfoHelper:function(a){},showPlaceholder:function(){var a=tdcAdminWrapperUI.$placeholder;!1===tdcOperationUI._isPlaceholderVisible&&(tdcOperationUI._isPlaceholderVisible=!0,a.show(),tdcOperationUI.updateInfoHelper(d))},
hidePlaceholder:function(){var a=tdcAdminWrapperUI.$placeholder;!0===tdcOperationUI._isPlaceholderVisible&&(tdcOperationUI._isPlaceholderVisible=!1,a.hide(),tdcOperationUI.updateInfoHelper(!0))},isPlaceholderVisible:function(){return tdcOperationUI._isPlaceholderVisible},isRowDragged:function(){var a=tdcOperationUI.getDraggedElement();return!b.isUndefined(a)&&tdcOperationUI.hasClassDraggedElement(tdcRowUI.getElementCssClass())},inRow:function(a){a=a.closest("."+tdcRowUI.getElementCssClass());if(a.length)return a},
isRow:function(a){return a.hasClass(tdcRowUI.getElementCssClass())},isTempRowDragged:function(){var a=tdcOperationUI.getDraggedElement();return!b.isUndefined(a)&&(tdcOperationUI.hasClassDraggedElement("tdc-row-temp")||tdcOperationUI.hasClassDraggedElement("tdc-sidebar-big-grid"))},isColumnDragged:function(a){var c=tdcOperationUI.getDraggedElement(),c=!b.isUndefined(c)&&tdcOperationUI.hasClassDraggedElement(tdcColumnUI.getElementCssClass());b.isUndefined(a)||(c=c&&(0<a.siblings(".tdc-column.tdc-dragged").length||
...
if(a.length)return a},isInnerColumn:function(a){return a.hasClass(tdcInnerColumnUI.getElementCssClass())},isElement:function(a){return a.hasClass(tdcElementUI.getElementCssClass())},isElementDragged:function(){var a=tdcOperationUI.getDraggedElement();return!b.isUndefined(a)&&tdcOperationUI.hasClassDraggedElement("tdc-element")},isSidebarElementDragged:function(){var a=tdcOperationUI.getDraggedElement();return!b.isUndefined(a)&&tdcOperationUI.hasClassDraggedElement("tdc-sidebar-element")},isSidebarBigGridDragged:function(){var a=
tdcOperationUI.getDraggedElement();return!b.isUndefined(a)&&tdcOperationUI.hasClassDraggedElement("tdc-sidebar-big-grid")},setPlaceholder:function(a,c){var g=tdcAdminWrapperUI.$placeholder;if(b.isUndefined(tdcOperationUI._placeholderCacheCssSettings.classes)||!b.isUndefined(tdcOperationUI._placeholderCacheCssSettings.classes)&&tdcOperationUI._placeholderCacheCssSettings.classes!==a)tdcOperationUI._placeholderCacheCssSettings.classes=a,a.length?g.addClass(a):g.attr("class","");b.isObject(c)&&(b.isUndefined(tdcOperationUI._placeholderCacheCssSettings.props)||
!b.isUndefined(tdcOperationUI._placeholderCacheCssSettings.props)&&!b.isEqual(tdcOperationUI._placeholderCacheCssSettings.props,c))&&(tdcOperationUI._placeholderCacheCssSettings.props=c,g.css(c))},setHorizontalPlaceholder:function(a){tdcOperationUI.setPlaceholder("",a)},setVerticalPlaceholder:function(a){tdcOperationUI.setPlaceholder("vertical",a)},_moveDraggedElement:function(){var a=tdcOperationUI.getDraggedElement(),c=tdcOperationUI.getCurrentElementOver(),g=tdcAdminWrapperUI.$placeholder,l="";
if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(g)||!g.is(":visible")&&c!==tdcAdminWrapperUI.$recycle)){var h=tdcOperationUI.isSidebarElementDragged(),e=tdcOperationUI.isElementDragged(),k=!1,m=!1,n=!1,p=!1,u=!1,v=!1,w=tdcOperationUI.isSidebarBigGridDragged();if(e){var r=a.closest(".tdc-elements");h||(l=tdcIFrameData._getSourceCol())}else(k=tdcOperationUI.isInnerColumnDragged())&&(r=a.closest(".tdc-inner-columns"));!k&&(m=tdcOperationUI.isInnerRowDragged(),n=tdcOperationUI.isTempInnerRowDragged(),
m||n)&&(r=a.closest(".tdc-elements"));m||n||(p=tdcOperationUI.isColumnDragged())&&(r=a.closest(".tdc-columns"));!p&&(u=tdcOperationUI.isRowDragged(),v=tdcOperationUI.isTempRowDragged(),u||v)&&(r=a.closest("#tdc-rows"));if(h||e||k||m||n||p||u||v){var t="",B=a.find(".td_block_inner");B.length&&(t=B.attr("id"));if(!h&&!b.isUndefined(r)&&r.length){var x=r.children(),B=x.index(a),y=x.index(g);if(c!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(B-y))return;if(e||m||n||u||v){if((e||m||u)&&c===tdcAdminWrapperUI.$recycle){g=
"Deleting ";tdConfirm.showModal(m?g+"inner row":u?g+"row":g+"element",tdcOperationUI,function(){if((-1===y&&1===x.length||2===x.length&&-1!==y)&&(!u||1!==tdcIFrameData.tdcRows.length)){var c="";z=a.closest(".tdc-inner-column");z.length?c=" tdc-element-inner-column":(A=a.closest(".tdc-column"),A.length&&(c=" tdc-element-column"));c=f('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);r.append(c)}tdcOperationUI.setDraggedElement(a);
tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({wasSidebarElementDragged:h,wasElementDragged:e,wasInnerColumnDragged:k,wasInnerRowDragged:m,wasTempInnerRowDragged:n,wasColumnDragged:p,wasRowDragged:u,wasTempRowDragged:v,wasSidebarBigGridDragged:w,draggedBlockUid:t,sourceColParam:l});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(d);tdcOperationUI.setCurrentElementOver(d);tb_remove()},d,"Are you sure you want to delete this element?");return}if(-1===
y&&1===x.length||2===x.length&&-1!==y){c="";var z=a.closest(".tdc-inner-column");if(z.length)c=" tdc-element-inner-column";else{var A=a.closest(".tdc-column");A.length&&(c=" tdc-element-column")}c=f('<div class="'+tdcOperationUI._emptyElementClass+c+'" title="Empty element that should be removed by composer"></div>');tdcElementUI.bindEmptyElement(c);r.append(c)}}}h&&(c="",e?c="tdc-element":n?c="tdc-element-inner-row-temp":m?c="tdc-element-inner-row":v?c="tdc-row-temp":u&&(c="tdc-row"),c=f('<div class="'+
c+'">'+a.html()+"</div>"),c.data("shortcodeName",a.data("shortcodeName")),tdcOperationUI.setDraggedElement(c),a=tdcOperationUI.getDraggedElement());g.replaceWith(a);if(h||e)z=a.closest(".tdc-inner-column"),z.length?(a.removeClass("tdc-element-column"),a.addClass("tdc-element-inner-column")):(A=a.closest(".tdc-column"),A.length&&(a.removeClass("tdc-element-inner-column"),a.addClass("tdc-element-column")));g=a.prev();g.hasClass(tdcOperationUI._emptyElementClass)&&g.remove();g=a.next();g.hasClass(tdcOperationUI._emptyElementClass)&&
g.remove();tdcIFrameData.changeData({wasSidebarElementDragged:h,wasElementDragged:e,wasInnerColumnDragged:k,wasInnerRowDragged:m,wasTempInnerRowDragged:n,wasColumnDragged:p,wasRowDragged:u,wasTempRowDragged:v,wasSidebarBigGridDragged:w,draggedBlockUid:t,sourceColParam:l})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}}}})(jQuery,Backbone,_);var tdcRowUI;
...
function(c){if(tdcOperationUI.isRowDragged()||tdcOperationUI.isTempRowDragged()){var b=a.outerHeight(!0),d=a.outerWidth(),h=a.offset();parseInt(h.left)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(h.left+d)&&parseInt(h.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(h.top+b)&&(tdcOperationUI.setCurrentElementOver(a),tdcRowUI.positionRowPlaceholder(c))}})},positionRowPlaceholder:function(a,c){var g=tdcAdminWrapperUI.$placeholder,l=0,h=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===
a.type)l=a.pageX,h=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){var l=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX,h=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY,e={pageX:l,pageY:h};tdcOperationUI.setCurrentElementOver(d);tdcRowUI.tdcRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",
e))});return}l=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(l))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight(),m=tdcOperationUI.getCurrentElementOverOuterWidth(),n=tdcOperationUI.getCurrentElementOverOffset();if(h>n.top+k/2){h=l.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)l.after(g),tdcOperationUI.updateInfoHelper();parseInt(n.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+
parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"",right:"auto",bottom:"0",width:m,"margin-left":""}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"",right:"",bottom:"",width:m,"margin-left":""})}else{h=l.prev();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)l.before(g),tdcOperationUI.updateInfoHelper();parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",
...
(c.preventDefault(),tdcOperationUI.setCurrentElementOver(d),tdcColumnUI.positionColumnPlaceholder(c)):(tdcMaskUI.setCurrentContainer(d),c=tdcOperationUI.inRow(a),b.isUndefined(c)||c.mouseenter())}).on("fakemouseenterevent",function(c){if(tdcOperationUI.isColumnDragged(a)){var b=a.find(".tdc-elements:first");if(b.length){var d=b.outerHeight(!0),b=b.outerWidth(),h=a.offset(),e=0,k=a.prevAll("."+tdcColumnUI._elementCssClass);k.length&&k.each(function(a,c){e+=parseInt(f(c).find(".tdc-elements:first").width())});
e+=h.left;parseInt(e)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(e+b)&&parseInt(h.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(h.top+d)&&(tdcOperationUI.setCurrentElementOver(a),tdcColumnUI.positionColumnPlaceholder(c))}}})},positionColumnPlaceholder:function(a,c){var g,l=tdcAdminWrapperUI.$placeholder,h=g=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)g=a.pageX,h=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=
a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){g=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX;var h=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY,e={pageX:g,pageY:h};tdcOperationUI.setCurrentElementOver(d);tdcOperationUI.getDraggedElement().closest(".tdc-columns").find(".tdc-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",e))});return}h=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(h))tdcOperationUI.hidePlaceholder();else{var k=h.find(".vc_column_container:first").outerWidth(!0),m=tdcOperationUI.getCurrentElementOverOffset(),n=0,p=h.prevAll();p.length&&p.each(function(a,c){var b=f(c);b.hasClass("tdc-column")&&(n+=parseInt(b.find(".vc_column_container:first").outerWidth(!0)))});var p=h.parent(".tdc-columns").parent(".vc_row"),u=p.css("position");if(b.isUndefined(u)||"static"!==u)if(p=p.css("padding-left"),b.isUndefined(p)||
(p=parseInt(p.replace("px",""))),g>n+m.left+k/2){g=h.next();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)h.after(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+k+p),"margin-left":-24})}else{g=h.prev();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)h.before(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24})}else if(n+=m.left,g>n+k/2){g=h.next();
if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)h.after(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+k),"margin-left":-24})}else{g=h.prev();if(!g.length||g.length&&g.attr("id")!==tdcAdminWrapperUI.placeholderId)h.before(l),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n),"margin-left":-24})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcColumnUI._elementCssClass}}})(jQuery,
...
tdcOperationUI.isTempInnerRowDragged()){var b=a.outerHeight(!0),d=a.outerWidth(),h=a.offset();parseInt(h.left)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(h.left+d)&&parseInt(h.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(h.top+b)&&(tdcOperationUI.setCurrentElementOver(a),tdcInnerRowUI.positionInnerRowPlaceholder(c))}})},positionInnerRowPlaceholder:function(a,c){var g=tdcAdminWrapperUI.$placeholder,l=0,h=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)l=
a.pageX,h=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){var l=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX,h=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY,e={pageX:l,pageY:h};tdcOperationUI.setCurrentElementOver(d);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",
e))});tdcInnerRowUI.tdcElementInnerRow.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",e))});return}l=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(l))tdcOperationUI.hidePlaceholder();else{var k=l.outerHeight(!0),m=l.innerWidth(),n=l.offset();if(h>n.top+k/2){h=l.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)l.after(g),tdcOperationUI.updateInfoHelper(d);
parseInt(n.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:m}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:m})}else{h=l.prev();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)l.before(g),tdcOperationUI.updateInfoHelper(d);parseInt(n.top)<
...
a.find(".tdc-elements:first");if(b.length){var d=b.outerHeight(!0),b=b.outerWidth(),h=a.offset(),e=0,k=a.prevAll("."+tdcInnerColumnUI._elementCssClass);k.length&&k.each(function(a,c){e+=parseInt(f(c).find(".tdc-elements:first").width())});e+=h.left;parseInt(e)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(e+b)&&parseInt(h.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(h.top+d)&&(tdcOperationUI.setCurrentElementOver(a),tdcInnerColumnUI.positionInnerColumnPlaceholder(c))}}})},positionInnerColumnPlaceholder:function(a,
c){var g=tdcAdminWrapperUI.$placeholder,l=0,h=0;if("mousedown"===a.type||"mousemove"===a.type||"fakemouseenterevent"===a.type)l=a.pageX,h=a.pageY,b.isUndefined(a.clientX)||b.isUndefined(a.clientY)||(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){var l=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX,h=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY,e={pageX:l,pageY:h};tdcOperationUI.setCurrentElementOver(d);
tdcOperationUI.getDraggedElement().closest(".tdc-inner-columns").find(".tdc-inner-column").each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",e))});return}h=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(h))tdcOperationUI.hidePlaceholder();else{var k=h.find(".vc_column_container:first").outerWidth(!0),m=h.offset(),n=0,p=h.prevAll();p.length&&p.each(function(a,c){var b=f(c);
b.hasClass("tdc-inner-column")&&(n+=parseInt(b.find(".vc_column_container:first").outerWidth(!0)))});p=h.parent(".tdc-inner-columns").parent(".vc_row_inner").css("padding-left");p=b.isUndefined(p)?0:parseInt(p.replace("px",""));if(l>n+m.left+k/2){l=h.next();if(!l.length||l.length&&l.attr("id")!==tdcAdminWrapperUI.placeholderId)h.after(g),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+k+p),"margin-left":-24})}else{l=h.prev();if(!l.length||l.length&&l.attr("id")!==
tdcAdminWrapperUI.placeholderId)h.before(g),tdcOperationUI.updateInfoHelper();tdcOperationUI.setVerticalPlaceholder({left:parseInt(n+p),"margin-left":-24})}b.isUndefined(c)||!0!==c?tdcOperationUI.showPlaceholder():tdcOperationUI.hidePlaceholder()}},getElementCssClass:function(){return tdcInnerColumnUI._elementCssClass}}})(jQuery,Backbone,_);var tdcElementsUI;
...
(window.previousMouseClientX=a.clientX,window.previousMouseClientY=a.clientY);else if("scroll"===a.type){var l=tdcOperationUI.iframeContents.scrollLeft()+window.previousMouseClientX,h=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY,e={pageX:l,pageY:h};tdcOperationUI.setCurrentElementOver(d);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",e))});return}var k=tdcOperationUI.getCurrentElementOver();
if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(k))tdcOperationUI.hidePlaceholder();else{var m=tdcOperationUI.getCurrentElementOverOuterHeight(),l=tdcOperationUI.getCurrentElementOverOuterWidth(),n=tdcOperationUI.getCurrentElementOverOffset();if(h>n.top+m/2){var p=!1;tdcElementUI.isInnerColumnLastElement(k)&&h>n.top+m-tdcElementUI._innerColumnGap&&(p=!0);p&&(k=k.closest(".tdc-element-inner-row"),l=k.outerWidth(!0));h=k.next();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)k.after(g),
tdcOperationUI.updateInfoHelper(d);parseInt(n.top)+parseInt(m)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"","margin-left":"",bottom:"0",width:l}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",width:l})}else{m=!1;tdcElementUI.isInnerColumnFirstElement(k)&&h<n.top+tdcElementUI._innerColumnGap&&(m=!0);m&&
(k=k.closest(".tdc-element-inner-row"),l=k.outerWidth(!0));h=k.prev();if(!h.length||h.length&&h.attr("id")!==tdcAdminWrapperUI.placeholderId)k.before(g),tdcOperationUI.updateInfoHelper(d);parseInt(n.top)<parseInt(tdcOperationUI.iframeContents.scrollTop())?tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"0",left:"","margin-top":"0","margin-left":"",bottom:"",width:l}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":"","margin-left":"",bottom:"",
...
l=tdcOperationUI.iframeContents.scrollTop()+window.previousMouseClientY;var h={pageX:g,pageY:l};tdcOperationUI.setCurrentElementOver(d);tdcElementUI.tdcElement.each(function(a,c){b.isUndefined(tdcOperationUI.getCurrentElementOver())&&f(c).trigger(f.Event("fakemouseenterevent",h))});return}var e=tdcOperationUI.getCurrentElementOver();if(b.isUndefined(tdcOperationUI.getDraggedElement())||b.isUndefined(e))tdcOperationUI.hidePlaceholder();else{var k=tdcOperationUI.getCurrentElementOverOuterHeight();a=
tdcOperationUI.getCurrentElementOverOuterWidth();g=tdcOperationUI.getCurrentElementOverOffset();if(l>g.top+k/2){var m=!1;tdcElementUI.isInnerColumnLastElement(e)&&l>g.top+k-tdcElementUI._innerColumnGap&&(m=!0);m?(l=e.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),m=l.next(),m.length||(l.after(c),tdcOperationUI.updateInfoHelper(d))):(m=e.next(),m.length||(e.after(c),tdcOperationUI.updateInfoHelper(d)));parseInt(g.top)+parseInt(k)>parseInt(tdcOperationUI.iframeContents.scrollTop())+parseInt(window.innerHeight)?
tdcOperationUI.setHorizontalPlaceholder({position:"fixed",top:"",left:"","margin-top":"","margin-left":"",bottom:0,width:a}):tdcOperationUI.setHorizontalPlaceholder({position:"absolute",top:"",left:"","margin-top":-50,"margin-left":"",bottom:"",width:a})}else k=!1,tdcElementUI.isInnerColumnFirstElement(e)&&l<g.top+tdcElementUI._innerColumnGap&&(k=!0),k?(l=e.closest(".tdc-element-inner-row"),a=l.outerWidth(!0),k=l.prev(),k.length||(l.before(c),tdcOperationUI.updateInfoHelper(d))):(k=e.prev(),k.length||
...
c.stopPropagation();var b=a.outerHeight(!0),d=a.outerWidth(),h=a.offset();parseInt(h.left)<=parseInt(c.pageX)&&parseInt(c.pageX)<=parseInt(h.left+d)&&parseInt(h.top)<=parseInt(c.pageY)&&parseInt(c.pageY)<=parseInt(h.top+b)&&(tdcOperationUI.setCurrentElementOver(a),tdcElementUI.positionElementPlaceholder(c))}})},bindEmptyElement:function(a){a.click(function(a){a.preventDefault()}).mousedown(function(c){1===c.which&&(a.hasClass("tdc-element-column")?tdcColumnHandlerUI._triggerEvent(c):a.hasClass("tdc-element-inner-column")&&
...
tdcMaskUI.$wrapper.append(tdcMaskUI.$handlerStructure),tdcRowHandlerUI.init(c),tdcColumnHandlerUI.init(c),tdcInnerRowHandlerUI.init(c),tdcInnerColumnHandlerUI.init(c),tdcElementHandlerUI.init(c),tdcMaskUI._isInitialized=!0)},setCurrentContainer:function(a){if(tdcMaskUI._isInitialized)if(tdcMaskUI.$currentContainer=a,b.isUndefined(tdcMaskUI.$currentContainer))tdcMaskUI.$content.css({top:"",left:"",width:"",height:""}),tdcMaskUI.$content.hide(),tdcSidebar.setSidebarInfo("");else{var c="";if(tdcOperationUI.isRow(tdcMaskUI.$currentContainer)){var g=
tdcMaskUI.$currentContainer;c="tdc-content-row"}else tdcOperationUI.isColumn(tdcMaskUI.$currentContainer)?(g=tdcMaskUI.$currentContainer.children(":first"),c="tdc-content-column"):tdcOperationUI.isInnerRow(tdcMaskUI.$currentContainer)?(g=tdcMaskUI.$currentContainer,c="tdc-content-inner-row"):tdcOperationUI.isInnerColumn(tdcMaskUI.$currentContainer)&&(g=tdcMaskUI.$currentContainer.children(":first"),c="tdc-content-inner-column");var d=g.offset();a=d.top;d=d.left;var h=g.outerWidth();g=g.outerHeight(!0);
tdcMaskUI.$content.css({top:a,left:d,width:h,height:g});tdcMaskUI.$content.attr("class",c);tdcMaskUI.$content.show();g=tdcMaskUI.$currentContainer.data("model_id");b.isUndefined(g)||(g=tdcIFrameData.getModel(g),tdcSidebar.setSidebarInfo(g.get("tag")));tdcElementHandlerUI.hide()}},setCurrentElement:function(a){if(tdcMaskUI._isInitialized)if(tdcMaskUI.$currentElement=a,b.isUndefined(tdcMaskUI.$currentElement))tdcMaskUI.$wrapper.hide(),tdcMaskUI.$content.hide();else{a=tdcMaskUI.$currentElement.offset();
...
var h=tdcOperationUI.getDraggedElement();h.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(h);var e=h.prevAll(".tdc-row").length,c=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row",type:"closed",level:0,parentModel:d});new tdcIFrameData.TdcLiveView({model:c,el:h[0]});l=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:c});h.data("model_id",c.cid);tdcIFrameData.tdcRows.add(c,{at:e});h=new tdcIFrameData.TdcCollection;
h.add(l);c.set("childCollection",h);h=new tdcIFrameData.TdcCollection;l.set("childCollection",h);c.getShortcodeRender(1,"",!0,a);tdcOperationUI.setDraggedElement(d);tb_remove()}},[a],"Are you sure you want to clone the current row and all its elements?"),tdcRowHandlerUI._inCloneOperation=!1)},deleteHandler:function(a){null!==a&&a.preventDefault();a.preventDefault();a.stopPropagation();tdConfirm.showModal("Delete row",tdcRowHandlerUI,function(a){a=f(a.currentTarget);if(a.hasClass("tdc-sidebar-delete-row")){a=
...
attrs:b.clone(a.get("attrs")),tag:"vc_row_inner",type:"closed",level:2,parentModel:a.get("parentModel")});new tdcIFrameData.TdcLiveView({model:c,el:h[0]});l=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:c});h.data("model_id",c.cid);a.get("parentModel").get("childCollection").add(c,{at:e});h=new tdcIFrameData.TdcCollection;h.add(l);c.set("childCollection",h);h=new tdcIFrameData.TdcCollection;l.set("childCollection",h);l=tdcIFrameData._getDestinationCol();
...
!0,!1);else{var c=a.clone(),l=a.get("parentModel").get("childCollection");l.add(c,{at:l.indexOf(a)+1,silent:!0});tdcOperationUI.setDraggedElement(f('<div class="tdc-element">Cloned Element</div>'));l=tdcOperationUI.getDraggedElement();l.insertAfter(tdcElementHandlerUI.$element);tdcElementUI.bindElement(l);var h=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(h)&&new tdcNotice.notice("tdcElementHandlerUI -> tdcElementHandlerUI._$handlerClone Error: Destination model not in structure data!",
!0,!1);h=tdcIFrameData._getDestinationCol();new tdcIFrameData.TdcLiveView({model:c,el:l[0]});l.data("model_id",c.cid);c.getShortcodeRender(h,"",!1,a);tdcOperationUI.setDraggedElement(d)}}),tdcElementHandlerUI._$handlerWrapper.mousedown(function(a){1===a.which&&tdcElementHandlerUI._triggerEvent(a)}).mouseup(function(a){tdcElementHandlerUI._triggerEvent(a)}).mousemove(function(a){tdcMaskUI.show();tdcElementHandlerUI._triggerEvent(a)}).mouseenter(function(a){a.preventDefault();tdcMaskUI.setCurrentElement(tdcElementHandlerUI.$element);
...
new tdcNotice.notice("Errors happened during tdcIframeData.init() -> bindViewsModelsWrappers()!",!0,!1)}tdcDebug.log(tdcIFrameData.tdcRows.models);tdcIFrameData._isInitialized=!0}},_defineStructuredData:function(){tdcIFrameData._isInitialized||(tdcIFrameData.TdcModel=Backbone.Model.extend({getShortcodeRender:function(a,c,g,l){var h=this,e={error:d,getShortcode:""};b.isUndefined(l)?tdcIFrameData._checkModelData(h,e):tdcIFrameData._checkModelData(l,e);if(!b.isUndefined(e.getShortcode)){var k=new tdcJobManager.job;
k.shortcode=e.getShortcode;k.columns=a;k.blockUid=c;k.success_callback=function(a){tdcDebug.log(a);var e=tdcAdminIFrameUI.getIframeWindow();b.isUndefined(l)&&tdcIFrameData.deleteCallback(h);!1===g?h.set("blockUid",a.blockUid):h.set("blockUid",d);b.has(a,"replyHtml")&&(h.set("bindNewContent",g),h.set("shortcode",k.shortcode),h.set("html",a.replyHtml));b.has(a,"replyJsForEval")&&(e.tdcEvalGlobal={oldBlockUid:c},tdcAdminIFrameUI.evalInIframe(a.replyJsForEval))};k.error_callback=function(a,c){tdcDebug.log(c);
tdcDebug.log(a)};a=tdcOperationUI.getDraggedElement();b.isUndefined(a)||a.addClass("tdc-dropped");tdcJobManager.addJob(k)}e={error:d,getShortcode:""};tdcIFrameData._checkModelData(h,e);b.isUndefined(e.error)||tdcDebug.log(e.error);e={error:d,getShortcode:""};b.isUndefined(h.get("parentModel"))||(tdcIFrameData._checkModelData(h.get("parentModel"),e),b.isUndefined(e.error)||tdcDebug.log(e.error))}}),tdcIFrameData.TdcCollection=Backbone.Collection.extend({model:tdcIFrameData.TdcModel}),tdcIFrameData.TdcLiveView=
...
if(!b.isUndefined(c)&&(a={},tdcIFrameData.bindViewsModelsWrappers(a,c,this.$el,1),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcRowUI.init(this.$el.parent());tdcColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:this.$el,$currentColumn:tdcOperationUI.inColumn(g),$currentElement:g})}else if(this.$el.hasClass("tdc-row")){d=this.$el.find(".tdc-row");c=this.model.get("childCollection");
b.isUndefined(c)||c.reset();this.$el.html(d.html());this.$el.attr("class",d.attr("class"));this.$el.attr("id",d.attr("id"));this.model.set("blockUid",d.attr("id"));window.addRowWrappers(this.$el);d=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(1,d,this.model)&&!b.isUndefined(c)&&(a={},tdcIFrameData.bindViewsModelsWrappers(a,c,this.$el,1),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
...
c,this.$el,2),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:this.$el})}else if(this.$el.hasClass("tdc-inner-row")){d=this.$el.find(".tdc-inner-row");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();this.$el.html(d.html());
window.addInnerRowWrappers(this.$el);d=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(3,d,this.model)&&!b.isUndefined(c)&&(a={},tdcIFrameData.bindViewsModelsWrappers(a,c,this.$el,3),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),
$currentInnerRow:this.$el})}else if(this.$el.hasClass("tdc-inner-column")){a=this.$el.find(".tdc-inner-column");c=this.model.get("childCollection");b.isUndefined(c)||c.reset();this.$el.html(a.html());window.addInnerColumnWrappers(this.$el);d=this.model.get("shortcode");if(!0===tdcIFrameData._initNewContentStructureData(4,d,this.model)&&!b.isUndefined(c)&&(a={},tdcIFrameData.bindViewsModelsWrappers(a,c,this.$el,4),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}tdcElementUI.init(this.$el);tdcSidebar.setSettings({$currentRow:tdcOperationUI.inRow(this.$el),$currentColumn:tdcOperationUI.inColumn(this.$el),$currentInnerRow:tdcOperationUI.inInnerRow(this.$el),$currentInnerColumn:this.$el})}else if("tdc-rows"===this.$el.attr("id")){d=this.$el.find(".tdc-row");g=this.model.cid;a=tdcIFrameData.getModel(g);c=a.get("childCollection");d.data("model_id",g);this.model.set("blockUid",d.attr("id"));window.addRowWrappers(this.$el);if(!b.isUndefined(c)&&(a=
{},tdcIFrameData.bindViewsModelsWrappers(a,c,d,1),!b.isEmpty(a))){for(e in a)tdcDebug.log(a[e]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}tdcRowUI.init(this.$el);tdcColumnUI.init(this.$el);tdcInnerRowUI.init(this.$el);tdcInnerColumnUI.init(this.$el);tdcElementUI.init(this.$el);this.$el=d;tdcSidebar.setSettings({$currentRow:d})}}}}))},_getPostOriginalContentJSON:function(){if(b.isUndefined(tdcIFrameData._postOriginalContentJSON)&&!b.isUndefined(window.tdcPostSettings)){var a=
Object.keys(window.tdcAdminSettings.mappedShortcodes),a=a.filter(function(a){return 0>["vc_row","vc_column","vc_row_inner","vc_column_inner"].indexOf(a)}),a={0:["vc_row"],1:["vc_column"],2:["vc_row_inner"],3:["vc_column_inner"],4:a};tdcIFrameData._shortcodeParserSettingsClone=a;tdcShortcodeParser.init(a);tdcIFrameData._postOriginalContentJSON=tdcShortcodeParser.parse(0,window.tdcPostSettings.postContent)}return tdcIFrameData._postOriginalContentJSON},_getContentJSON:function(a,c){var d;b.isUndefined(window.tdcPostSettings)||
(d=tdcShortcodeParser.parse(a,c));return d},_initStructuredData:function(){if(!tdcIFrameData._isInitialized){var a=tdcIFrameData._getPostOriginalContentJSON();tdcDebug.log(a);if(a.length){tdcIFrameData.tdcRows=new tdcIFrameData.TdcCollection;var c={};b.each(a,function(a,b,e){tdcIFrameData._getData(d,a,c)});b.isEmpty(c)||(tdcDebug.log(c),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",!0,!1));a={error:d,shortcode:d};tdcIFrameData.checkCurrentData(a);b.isUndefined(a.error)||
...
_getData:function(a,c,g,l){var e;var f=b.isUndefined(a)?tdcIFrameData.tdcRows:a.get("childCollection");for(var k in tdcIFrameData._shortcodeParserSettingsClone)if(!(!b.isUndefined(l)&&parseInt(l,10)>k||b.isUndefined(c.shortcode))&&b.isObject(c.shortcode)&&b.has(c.shortcode,"tag")&&-1!==b.indexOf(tdcIFrameData._shortcodeParserSettingsClone[k],c.shortcode.tag)){0<parseInt(k,10)&&b.isUndefined(a)&&(e="Not rows as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(k,10)&&(e=
"Elements does not respect the shortcode levels!");!b.isUndefined(a)&&1<parseInt(k,10)-parseInt(a.get("level"),10)&&2!==parseInt(a.get("level"),10)&&4!==parseInt(k,10)&&(e="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!");b.isUndefined(e)||(g[b.keys(g).length]={element:c,info:e,parentModel:a});4!==parseInt(k,10)||b.isUndefined(c.shortcode.content)||(l=b.clone(c.shortcode.attrs.named),l.content=c.shortcode.content,c.shortcode.attrs.named=l);var m=new tdcIFrameData.TdcModel({content:c.content,
attrs:c.shortcode.attrs.named,tag:c.shortcode.tag,type:c.shortcode.type,level:parseInt(k,10),parentModel:a,bindNewContent:!1});b.has(c,"child")&&0<c.child.length&&(m.set("childCollection",new tdcIFrameData.TdcCollection),b.each(c.child,function(a,c,b){tdcIFrameData._getData(m,a,g,d)}));break}b.isUndefined(m)?g[b.keys(g).length]={element:c,info:"Element not found!",parentModel:a}:b.isUndefined(f)||f.add(m)},getModel:function(a,c){if(tdcIFrameData._isInitialized){var d;b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);
b.each(c.models,function(c,g,e){b.isUndefined(d)&&(c.cid===a?d=c:c.has("childCollection")&&(c=c.get("childCollection"),d=tdcIFrameData.getModel(a,c)))});if(!b.isUndefined(d))return d}},getFirstModelByTag:function(a,c){if(tdcIFrameData._isInitialized){var d;b.isUndefined(c)&&(c=tdcIFrameData.tdcRows);b.each(c.models,function(c,g,e){b.isUndefined(d)&&(c.attributes.tag===a?d=c:c.has("childCollection")&&(c=c.get("childCollection"),d=tdcIFrameData.getFirstModelByTag(a,c)))});if(!b.isUndefined(d))return d}},
removeModel:function(a,c,d){(b.isUndefined(c)||!0===c)&&tdcIFrameData.deleteCallback(a);c=a.get("parentModel");b.isUndefined(d)&&(d={});b.isUndefined(c)?tdcIFrameData.tdcRows.remove(a,d):c.get("childCollection").remove(a,d)},deleteCallback:function(a){var c=a.get("blockUid");a=a.get("childCollection");tdcAdminIFrameUI.getIframeWindow().tdcComposerBlocksApi.deleteItem(c);!b.isUndefined(a)&&a.length&&b.each(a.models,function(a,c,b){tdcIFrameData.deleteCallback(a)})},_checkModelData:function(a,c){if(b.isUndefined(c.error)){var g=
...
0,c["tempShortcodeDeepLevel"+c.deepLevel]="");if(a.has("childCollection")){b.isUndefined(c.getShortcode)||(c.deepLevel++,c["tempShortcodeDeepLevel"+c.deepLevel]="");var l=a.get("childCollection");b.each(l.models,function(a,b,d){tdcIFrameData._checkModelData(l.get(a.cid),c)});b.isUndefined(c.getShortcode)||c.deepLevel--}if(!b.isUndefined(c.getShortcode)){var e=a.get("type"),g=a.get("tag"),f=a.get("attrs"),k="";if("td_block_text_with_title"===g||"vc_column_text"===g||"vc_raw_html"===g)b.map(f,function(a,
c){"content"!==c&&(k+=" "+c+'="'+a+'"')}),k=b.has(f,"content")?"["+g+k+"]"+b.unescape(f.content)+"[/"+g+"]":"["+g+k+"]";else switch(b.map(f,function(a,c){k+=" "+c+'="'+a+'"'}),e){case "single":k="["+g+k+"]";break;case "closed":e="",b.isUndefined(c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)])||(e=c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)],c["tempShortcodeDeepLevel"+(parseInt(c.deepLevel)+1)]=d),k="["+g+k+"]"+e+"[/"+g+"]"}c["tempShortcodeDeepLevel"+c.deepLevel]+=k;0===c.deepLevel&&
(c.getShortcode+=k)}}else c.error="Not rows as the first elements!"}},checkCurrentData:function(a){tdcIFrameData._isInitialized&&b.each(tdcIFrameData.tdcRows.models,function(c,b,d){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},changeData:function(a){if(tdcIFrameData._isInitialized){tdcMain.setContentModified();var c=tdcOperationUI.getDraggedElement();var g=c.prevAll().length;if(a.wasSidebarElementDragged)if(a.wasElementDragged){var e=tdcIFrameData._getDestinationModel([".tdc-inner-column",
".tdc-column"]);b.isUndefined(e)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);var h=tdcIFrameData._getDestinationCol();e.has("childCollection")||e.set("childCollection",new tdcIFrameData.TdcCollection);var f=e.get("childCollection");var k=c.data("shortcodeName");var m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:k,type:"single",level:4,parentModel:e});new tdcIFrameData.TdcLiveView({model:m,el:c[0]});tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(m.get("tag")+
" : sidebar element added");c.data("model_id",m.cid);f.add(m,{at:g});m.set("parentModel",e);m.getShortcodeRender(h,a.draggedBlockUid,!1)}else a.wasTempInnerRowDragged?(tdcRecycle.takeSnapshot("Sidebar inner-row added"),e=tdcIFrameData._getDestinationModel([".tdc-column"]),b.isUndefined(e)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),h=tdcIFrameData._getDestinationCol(),e.has("childCollection")||e.set("childCollection",new tdcIFrameData.TdcCollection),f=
e.get("childCollection"),m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:2,parentModel:e}),new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:3,parentModel:m}),c.data("model_id",m.cid),f.add(m,{at:g}),c=new tdcIFrameData.TdcCollection,c.add(k),m.set("childCollection",c),c=new tdcIFrameData.TdcCollection,k.set("childCollection",c),m.getShortcodeRender(h,a.draggedBlockUid,
!0)):a.wasTempRowDragged&&(tdcRecycle.takeSnapshot("Sidebar row added"),m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:d}),new tdcIFrameData.TdcLiveView({model:m,el:c[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:m}),c.data("model_id",m.cid),tdcIFrameData.tdcRows.add(m,{at:g}),g=new tdcIFrameData.TdcCollection,g.add(h),m.set("childCollection",g),g=new tdcIFrameData.TdcCollection,h.set("childCollection",
g),a.wasSidebarBigGridDragged&&(m.set({attrs:{full_width:"stretch_row_content td-stretch-content"}}),k=c.data("shortcodeName"),c=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:k,type:"single",level:2,parentModel:h}),g.add(c),g=new tdcIFrameData.TdcCollection,c.set("childCollection",g)),m.getShortcodeRender(1,a.draggedBlockUid,!0));else{m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model id is not in $draggedElement data!",!0,!1);return}m=tdcIFrameData.getModel(m);
if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(m);return}tdcRecycle.takeSnapshot(m.get("tag")+" : element moved");var n=m.get("parentModel");e=tdcIFrameData._getDestinationModel([".tdc-inner-column",".tdc-column"]);b.isUndefined(e)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1);n.cid===e.cid?(h=n.get("childCollection"),h.remove(m,{silent:!0}),h.add(m,{at:g})):(h=tdcIFrameData._getDestinationCol(),e.has("childCollection")||e.set("childCollection",new tdcIFrameData.TdcCollection),f=e.get("childCollection"),tdcIFrameData.removeModel(m,!1,{silent:!0}),f.add(m,{at:g}),m.set("parentModel",e),a.sourceColParam!==h&&m.getShortcodeRender(h,a.draggedBlockUid,!1))}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");
tdcRecycle.takeSnapshot("Inner row recycled");tdcIFrameData.removeModel(m);return}tdcRecycle.takeSnapshot("Inner row moved");n=m.get("parentModel");e=tdcIFrameData._getDestinationModel([".tdc-column"]);b.isUndefined(e)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(n.cid===e.cid)h=n.get("childCollection"),h.remove(m,{silent:!0}),h.add(m,{at:g});else{e.has("childCollection")||e.set("childCollection",new tdcIFrameData.TdcCollection);f=e.get("childCollection");
tdcIFrameData.removeModel(m,!0,{silent:!0});f.add(m,{at:g});m.set("parentModel",e);a=n.get("attrs");g=e.get("attrs");if(b.has(a,"width"))switch(a.width){case "1/3":h="13";break;case "2/3":h="23"}if(b.has(g,"width"))switch(g.width){case "1/3":k="13";break;case "2/3":k="23"}b.isUndefined(h)&&(h="11");b.isUndefined(k)&&(k="11");if(h!==k&&(a=m.get("childCollection"),!b.isUndefined(a))){a=tdcIFrameData.getChildCollectionWidths(a);b.isUndefined(a)&&(a="11");g="11";f=1;switch(k){case "11":switch(a){case "11":g=
"11";break;case "23_13":g="23_13";break;case "13_23":g="13_23";break;case "12_12":g="13_13_13";break;case "13_13_13":g="13_13_13"}f=3;break;case "13":switch(a){case "11":g="11";break;case "23_13":g="11";break;case "13_23":g="11";break;case "12_12":g="11";break;case "13_13_13":g="11"}break;case "23":switch(a){case "11":g="12_12";break;case "23_13":g="12_12";break;case "13_23":g="12_12";break;case "12_12":g="12_12";break;case "13_13_13":g="12_12"}f=2}if(a!==g||h!==k)tdcIFrameData.changeInnerRowModel(m,
a,g),m.getShortcodeRender(f,null,!0)}m=tdcOperationUI.inRow(c);a=tdcOperationUI.inColumn(c);c=tdcOperationUI.inInnerRow(c);b.isUndefined(m)||b.isUndefined(a)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:m,$currentColumn:a,$currentInnerRow:c},!0)}}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),a.wasColumnDragged?tdcRecycle.takeSnapshot("Column moved"):a.wasInnerColumnDragged&&tdcRecycle.takeSnapshot("Inner-column moved"),n=m.get("parentModel"),h=n.get("childCollection"),
h.remove(m,{silent:!0}),h.add(m,{at:g}),a.wasColumnDragged?(m=tdcOperationUI.inRow(c),b.isUndefined(m)||tdcSidebar.setSettings({$currentRow:m})):a.wasInnerColumnDragged&&(m=tdcOperationUI.inRow(c),a=tdcOperationUI.inColumn(c),c=tdcOperationUI.inInnerRow(c),b.isUndefined(m)||b.isUndefined(a)||b.isUndefined(c)||tdcSidebar.setSettings({$currentRow:m,$currentColumn:a,$currentInnerRow:c}));else if(a.wasRowDragged){tdcDebug.log("case 4");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("row recycled");
tdcRecycle.takeSnapshot("Row recycled");tdcIFrameData.removeModel(m);tdcDebug.log(tdcIFrameData.tdcRows);tdcIFrameData.tdcRows.length||(m=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:0,parentModel:d}),new tdcIFrameData.TdcLiveView({model:m,el:tdcIFrameData.iframeContents.find("#tdc-rows")[0]}),h=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:1,parentModel:m}),tdcIFrameData.tdcRows.add(m,{at:0}),g=new tdcIFrameData.TdcCollection,
g.add(h),m.set("childCollection",g),g=new tdcIFrameData.TdcCollection,h.set("childCollection",g),m.getShortcodeRender(1,a.draggedBlockUid,!0));return}tdcRecycle.takeSnapshot("Row moved");tdcIFrameData.tdcRows.remove(m,{silent:!0});tdcIFrameData.tdcRows.add(m,{at:g});tdcDebug.log("newPosition: "+g);tdcDebug.log(c)}}tdcDebug.log(tdcIFrameData.tdcRows)}},_parseModelWidthAttrs:function(a){a=a.get("attrs");var c=3;if(b.has(a,"width"))switch(a.width){case "1/3":c=1;break;case "2/3":c=2;break;case "1/2":c=
1}return c},getColumnNumber:function(a){var c=3,d=parseInt(a.get("level"),10),e=a.get("parentModel");b.isUndefined(e)||(a=4===d?tdcIFrameData._parseModelWidthAttrs(e):tdcIFrameData._parseModelWidthAttrs(a),c=3===a?tdcIFrameData.getColumnNumber(e):a);return c},_getDestinationModel:function(a){for(var c=tdcOperationUI.getDraggedElement(),d,e=0;e<a.length&&(d=c.closest(a[e]),!d.length);e++);d.length||new tdcNotice.notice("_getDestinationModel Error: Container destination not available!",!0,!1);a=d.data("model_id");
b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model id of the container destination not in data!",!0,!1);a=tdcIFrameData.getModel(a);b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model not in structure data!",!0,!1);return a},_getDestinationCol:function(){var a=tdcOperationUI.getDraggedElement();var c=a.closest(".tdc-column");a=a.closest(".tdc-inner-column");if(a.length&&(a=a.data("model_id"),b.isUndefined(a)&&new tdcNotice.notice("_getDestinationCol Error: The inner column model id not in data!",
...
"";b.each(tdcIFrameData.tdcRows.models,function(c,b,d){tdcIFrameData._checkModelData(tdcIFrameData.tdcRows.get(c.cid),a)})},bindViewsModelsWrappers:function(a,c,d,e){if(b.isEmpty(a)){b.isUndefined(e)&&(e=0);if(b.isUndefined(c)){c=tdcIFrameData.tdcRows;d=tdcIFrameData.iframeContents.find("#tdc-rows .tdc-row");if(c.models.length!==d.length){a[b.keys(a).length]={collection:c,jqDOMElements:d,info:"Error at rows: "+c.models.length+"(models) : "+d.length+"(dom)"};return}e++;b.each(d,function(b,d,g){d=c.models[d];
g=f(b);g.data("model_id",d.cid);d.set("blockUid",g.attr("id"));d.set("html",b.innerHTML);new tdcIFrameData.TdcLiveView({model:d,el:b});d.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,d.get("childCollection"),g,e)})}else{switch(e){case 1:var g=d.find(".tdc-columns:first").children(".tdc-column");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns: "+c.models.length+"(models) : "+g.length+"(dom)",level:e};return}break;case 2:g=d.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row");
if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns elements: "+c.models.length+"(models) : "+g.length+"(dom)",level:e};return}break;case 3:g=d.find(".tdc-inner-columns:first").children(".tdc-inner-column");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at inner columns: "+c.models.length+"(models) : "+g.length+"(dom)",level:e};return}break;case 4:if(g=d.find(".tdc-elements:first").children(".tdc-element"),
c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at elements: "+c.models.length+"(models) : "+g.length+"(dom)",level:e};return}}e++;b.each(g,function(d,g,l){g=c.models[g];l=f(d);l.data("model_id",g.cid);g.set("html",d.innerHTML,{silent:!0});var k;if(4===g.get("level")){var h=l.find(".td_block_inner");h.length&&(k=h.attr("id"))}else 2===g.get("level")&&(h=l.find(".tdc-inner-row"),h.length&&(k=h.attr("id")));g.set("blockUid",k);new tdcIFrameData.TdcLiveView({model:g,
el:d});!l.hasClass("tdc-element")&&g.has("childCollection")&&0<b.size(g.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,g.get("childCollection"),l,e)})}e--}},changeRowModel:function(a,c,d){var g=a.get("childCollection");if("11"===c&&("23_13"===d||"13_23"===d||"13_13_13"===d)){d=d.split("_");var e=d[0].charAt(0)+"/"+d[0].charAt(1);var f=g.at(0);var k=f.get("attrs");b.isUndefined(k)?f.set("attrs",{width:e}):(k=b.clone(k),k.width=e,f.set("attrs",k));g.add(new tdcIFrameData.TdcModel({content:"",
tag:"vc_column",attrs:{width:d[1].charAt(0)+"/"+d[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===d.length&&g.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:d[2].charAt(0)+"/"+d[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(f,c,d[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===d){c=c.split("_");f=g.at(0);k=f.get("attrs");var m=f.get("childCollection");var n=g.at(1);var p=n.get("childCollection");b.isUndefined(k)||
(k=b.clone(k),delete k.width,f.set("attrs",k));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,f.set("childCollection",m));!b.isUndefined(p)&&p.length&&b.each(p.models,function(a,c,b){a.set("parentModel",f);m.add(a)});3===c.length&&(g=g.at(2),a=g.get("childCollection"),!b.isUndefined(a)&&a.length&&b.each(a.models,function(a,c,b){a.set("parentModel",f);m.add(a)}),tdcIFrameData.removeModel(g));tdcIFrameData.removeModel(n);tdcIFrameData.changeColumnModel(f,c[0],d)}else if(!("23_13"!==c&&"13_23"!==
c&&"13_13_13"!==c||"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)){c=c.split("_");d=d.split("_");e=d[0].charAt(0)+"/"+d[0].charAt(1);var u=d[1].charAt(0)+"/"+d[1].charAt(1);f=g.at(0);k=f.get("attrs");n=g.at(1);var v=n.get("attrs");p=n.get("childCollection");3===d.length?g.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:d[2].charAt(0)+"/"+d[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(g=g.at(2),a=g.get("childCollection"),!b.isUndefined(a)&&a.length&&(b.isUndefined(p)&&
(p=new tdcIFrameData.TdcCollection,n.set("childCollection",p)),b.each(a.models,function(a,c,b){a.set("parentModel",n);p.add(a)})),tdcIFrameData.removeModel(g));k=b.clone(k);k.width=e;f.set("attrs",k);c[0]!==d[0]&&tdcIFrameData.changeColumnModel(f,c[0],d[0]);k=b.clone(v);k.width=u;n.set("attrs",k);c[1]!==d[1]&&tdcIFrameData.changeColumnModel(n,c[1],d[1])}tdcDebug.log(tdcIFrameData.tdcRows.models)},changeColumnModel:function(a,c,d){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(d))){var g=a.get("childCollection");
if(!b.isUndefined(g)&&g.length){var e=a.get("attrs");!b.isUndefined(e)&&b.has(e,"width");b.each(g.models,function(g,e,l){if("vc_row_inner"===g.get("tag")&&(g=g.get("childCollection"),!b.isUndefined(g)&&g.length)){var h="";b.each(g.models,function(a,c,d){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(h=c===d.length-1?h+a.width:h+(a.width+"_"))});h=h.replace(/\//g,"");"12_12"!==h&&"23_13"!==h&&"13_23"!==h&&"13_13_13"!==h&&(h="");if("11"===c)if("23"===d)if("23_13"===h){var f=g.at(0);
var k=g.at(1);e=f.get("attrs");l=k.get("attrs");e=b.clone(e);l=b.clone(l);e.width="1/2";l.width="1/2";f.set("attrs",e);k.set("attrs",l)}else if("13_23"===h)f=g.at(0),k=g.at(1),e=f.get("attrs"),l=k.get("attrs"),e=b.clone(e),l=b.clone(l),e.width="1/2",l.width="1/2",f.set("attrs",e),k.set("attrs",l);else if("13_13_13"===h){f=g.at(0);k=g.at(1);g=g.at(2);e=f.get("attrs");l=k.get("attrs");var m=g.get("attrs");e=b.clone(e);l=b.clone(l);b.clone(m);e.width="1/2";l.width="1/2";f.set("attrs",e);k.set("attrs",
l);e=g.get("childCollection");if(!b.isUndefined(e)&&e.length){var q=k.get("childCollection");b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,k.set("childCollection",q));b.each(e.models,function(a,c,b){q.add(a);a.set("parentModel",k)})}tdcIFrameData.removeModel(g)}else{if(g.models.length){f=g.at(0);e=f.get("attrs");e=b.clone(e);var r=f.get("childCollection");delete e.width;f.set("attrs",e);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r));var t=0;for(b.each(g.models,
function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}}else{if("13"===d&&g.models.length)for(f=g.at(0),e=f.get("attrs"),e=b.clone(e),r=f.get("childCollection"),delete e.width,f.set("attrs",e),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),t=0,b.each(g.models,function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,
function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}else if("23"===c)if("11"===d)if("12_12"===h)f=g.at(0),k=g.at(1),e=f.get("attrs"),l=k.get("attrs"),e=b.clone(e),l=b.clone(l),e.width="1/3",l.width="1/3",f.set("attrs",e),k.set("attrs",l),e=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),g.add(e);else{if(g.models.length)for(f=g.at(0),e=f.get("attrs"),e=b.clone(e),r=f.get("childCollection"),
delete e.width,f.set("attrs",e),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),t=0,b.each(g.models,function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}else{if("13"===d&&g.models.length)for(f=g.at(0),e=f.get("attrs"),e=b.clone(e),r=f.get("childCollection"),delete e.width,f.set("attrs",e),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,
f.set("childCollection",r)),t=0,b.each(g.models,function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}else if("13"===c)if("11"===d)if(""===h||"12_12"!==h&&"23_13"!==h&&"13_23"!==h&&"13_13_13"!==h){if(g.models.length)for(f=g.at(0),e=f.get("attrs"),e=b.clone(e),r=f.get("childCollection"),delete e.width,f.set("attrs",e),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,
f.set("childCollection",r)),t=0,b.each(g.models,function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}else"12_12"===h&&g.models.length&&(f=g.at(0),k=g.at(1),e=f.get("attrs"),l=k.get("attrs"),e.width="1/3",l.width="1/3",f.set("attrs",e),k.set("attrs",l),g.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));
else if("23"===d&&(""===h||"12_12"!==h)&&g.models.length)for(f=g.at(0),e=f.get("attrs"),e=b.clone(e),r=f.get("childCollection"),delete e.width,f.set("attrs",e),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),t=0,b.each(g.models,function(a,c,d){0!==c&&(t=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<t;)tdcIFrameData.removeModel(g.at(t)),t--}})}}},changeInnerRowModel:function(a,c,d){if(!(b.isUndefined(a)||
b.isUndefined(c)||b.isUndefined(d))){var g=a.get("childCollection");if("11"===c&&("12_12"===d||"23_13"===d||"13_23"===d||"13_13_13"===d)){var e=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",type:"closed",level:3,parentModel:a});var f=d.split("_");var k=f[0].charAt(0)+"/"+f[0].charAt(1);c=f[1].charAt(0)+"/"+f[1].charAt(1);var m=g.at(0);var n=m.get("attrs");b.isUndefined(n)?m.set("attrs",{width:k}):(n=b.clone(n),n.width=k,m.set("attrs",n));e.set("attrs",{width:c});g.add(e);3===f.length&&
g.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:f[2].charAt(0)+"/"+f[2].charAt(1)},type:"closed",level:3,parentModel:a}))}else if("12_12"===c||"23_13"===c||"13_23"===c)if("11"===d){m=g.at(0);n=m.get("attrs");var p=m.get("childCollection");e=g.at(1);var u=e.get("childCollection");b.isUndefined(n)||(n=b.clone(n),delete n.width,m.set("attrs",n));b.isUndefined(p)&&(p=new tdcIFrameData.TdcCollection,m.set("childCollection",p));!b.isUndefined(u)&&u.length&&b.each(u.models,
function(a,c,b){a.set("parentModel",m);p.add(a)});tdcIFrameData.removeModel(e)}else{if("12_12"===d||"23_13"===d||"13_23"===d||"13_13_13"===d)f=d.split("_"),k=f[0].charAt(0)+"/"+f[0].charAt(1),c=f[1].charAt(0)+"/"+f[1].charAt(1),m=g.at(0),n=m.get("attrs"),e=g.at(1),d=e.get("attrs"),n=b.clone(n),n.width=k,m.set("attrs",n),d=b.clone(d),d.width=c,e.set("attrs",d),3===f.length&&g.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:f[2].charAt(0)+"/"+f[2].charAt(1)},type:"closed",
level:3,parentModel:a}))}else if("13_13_13"===c)if("11"===d)m=g.at(0),n=m.get("attrs"),p=m.get("childCollection"),e=g.at(1),u=e.get("childCollection"),g=g.at(2),a=g.get("childCollection"),b.isUndefined(n)||(n=b.clone(n),delete n.width,m.set("attrs",n)),b.isUndefined(p)&&(p=new tdcIFrameData.TdcCollection,m.set("childCollection",p)),!b.isUndefined(u)&&u.length&&b.each(u.models,function(a,c,b){a.set("parentModel",m);p.add(a)}),!b.isUndefined(a)&&a.length&&b.each(a.models,function(a,c,b){a.set("parentModel",
m);p.add(a)}),tdcIFrameData.removeModel(e),tdcIFrameData.removeModel(g);else if("12_12"===d||"23_13"===d||"13_23"===d)f=d.split("_"),k=f[0].charAt(0)+"/"+f[0].charAt(1),c=f[1].charAt(0)+"/"+f[1].charAt(1),m=g.at(0),n=m.get("attrs"),e=g.at(1),d=e.get("attrs"),u=e.get("childCollection"),g=g.at(2),a=g.get("childCollection"),n=b.clone(n),n.width=k,m.set("attrs",n),d=b.clone(d),d.width=c,e.set("attrs",d),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,e.set("childCollection",u)),!b.isUndefined(a)&&
a.length&&b.each(a.models,function(a,c,b){a.set("parentModel",e);u.add(a)}),tdcIFrameData.removeModel(g)}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;b.map(a.models,function(a,d){var g=a.get("attrs");b.has(g,"width")&&(c=b.isUndefined(c)?g.width.replace("/",""):c+("_"+g.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
tdDetect.isIe9||tdDetect.isIe10)&&tdConfirm.showModalOk("Browser Information","TagDiv Composer does not work with Internet Explorer 8, 9, 10",function(){tb_remove()});var a=f(this).contents();tdcAdminIFrameUI.initContent(a);tdcAdminIFrameUI._liveIframeWindowObject=f(this).get(0).contentWindow;var c=f('<div id="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');a.find("body").prepend(c);tdcAdminWrapperUI.$recycle=c;tdcIFrameData._postOriginalContentJSON=d;window.addWrappers(a);
tdcIFrameData.init(a,!0);tdcOperationUI.init(a,!0);a.on("click","a",function(a){a.preventDefault();"undefined"!==this.href&&window.open(this.href,"_blank")});a[0].addEventListener("mousedown",function(a){1!==a.which&&a.stopPropagation()},!0);a[0].addEventListener("mousemove",function(c){a.lastMouseEvent=c},!0)},checkIframe:function(a){if(b.isUndefined(a))a=window.tdcPostSettings.postUrl,a=0>a.indexOf("?")?a+("?td_action=tdc_edit&post_id="+window.tdcPostSettings.postId):a+("&td_action=tdc_edit&post_id="+
window.tdcPostSettings.postId),a=f('<iframe id="tdc-live-iframe" name="tdc-live-iframe" src="'+a+'" scrolling="auto" style="width: 100%; height: 100%"></iframe>').load(tdcAdminIFrameUI.loadIframe),f("#tdc-live-iframe-wrapper").append(a);else{var c=a,g=c.contents();tdcAdminIFrameUI.initContent(g);tdcAdminIFrameUI._liveIframeWindowObject=c.get(0).contentWindow;c=f('<div id="tdc-recycle"><div class="tdc-delete-text"><span>Delete</span></div></div>');g.find("body").prepend(c);tdcAdminWrapperUI.$recycle=
c;tdcIFrameData._postOriginalContentJSON=d;window.addWrappers(g);tdcIFrameData.init(g,!0);tdcOperationUI.init(g,!0);g.find("a").each(function(a,c){c.setAttribute("target","_blank")});a.removeClass("tdc-live-iframe");a.removeClass("tdc-live-iframe-temp")}tdcAdminIFrameUI._$liveIframe=a}}})(jQuery,Backbone,_);var tdcMain={};
...
$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},500)}});e.on("keyup focus paste cut change",".tdc-tab-no-design .tdc-property-textfield input",function(b){var d=setTimeout(function(a){clearTimeout(d);if("focusin"===b.type)a.oldValue=a.value;else{var c=jQuery(a).val(),g=tdcIFrameData.getModel(jQuery(a).data("model_id"));"cut"===b.type&&(c="");tdcSidebarController.onUpdate(g,
jQuery(a).data("param_name"),a.oldValue,_.escape(c));a.oldValue=c}},100,this,b)});e.on("focus change",".tdc-tab-no-design .tdc-property-checkbox input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this);var d=b.val();b.is(":checked")||(d="");var a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,d);this.oldValue=d}});e.on("click",".tdc-tab-no-design .tdc-image-wrap",tdcSidebarPanel.tdcImageWrapHandler);e.on("click",
".tdc-tab-no-design .tdc-image-remove",tdcSidebarPanel.tdcImageRemoveHandler);e.on("change keyup focus",".tdc-tab-no-design .tdc-property-colorpicker input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(d,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});e.on("change focus",".tdc-tab-no-design .tdc-row-col-dropdown select",function(b){if("focusin"===b.type||
"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcSidebar.getCurrentRow().data("model_id"),d=tdcIFrameData.getModel(d);"11"===this.oldValue&&("23_13"===b||"13_23"===b||"13_13_13"===b)||"23_13"===this.oldValue&&("11"===b||"13_23"===b||"13_13_13"===b)||"13_23"===this.oldValue&&("11"===b||"23_13"===b||"13_13_13"===b)||"13_13_13"===this.oldValue&&("11"===b||"23_13"===b||"13_23"===b)?(tdcIFrameData.changeRowModel(d,this.oldValue,b),d.getShortcodeRender(1,null,!0)):new tdcNotice.notice("Invalid row change detected: this.oldValue:"+
this.oldValue+" and curValue: "+b,!1,!0);this.oldValue=b}});e.on("change",".tdc-tab-no-design .tdc-row-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingColumns&&clearTimeout(tdcSidebarPanel.timerChangingColumns);var d=jQuery(this);tdcSidebarPanel.timerChangingColumns=setTimeout(function(){var a=d.val(),c=tdcSidebar.getCurrentRow().data("model_id"),c=tdcIFrameData.getModel(c),b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=
tdcIFrameData.getChildCollectionWidths(b),_.isUndefined(b)||(this.oldValue=b));"11"===this.oldValue&&("23_13"===a||"13_23"===a||"13_13_13"===a)||"23_13"===this.oldValue&&("11"===a||"13_23"===a||"13_13_13"===a)||"13_23"===this.oldValue&&("11"===a||"23_13"===a||"13_13_13"===a)||"13_13_13"===this.oldValue&&("11"===a||"23_13"===a||"13_23"===a)?(tdcIFrameData.changeRowModel(c,this.oldValue,a),c.getShortcodeRender(1,null,!0)):this.oldValue!==a&&new tdcNotice.notice("Invalid row change detected: this.oldValue:"+
this.oldValue+" and curValue: "+a,!1,!0);this.oldValue=a},300)});e.on("change",".tdc-tab-no-design .tdc-property-dropdown.tdc-add-class input.tdc-property-input-radio",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this);var d=b.val(),a=tdcIFrameData.getModel(b.data("model_id"));console.log(b.data("model_id"));console.log(b.data("param_name"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,d);this.oldValue=d}});e.on("change focus",".tdc-tab-no-design .tdc-innerRow-col-dropdown select",
function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcSidebar._$currentInnerRow.data("model_id"),d=tdcIFrameData.getModel(d);tdcIFrameData.changeInnerRowModel(d,this.oldValue,b);d.getShortcodeRender(tdcIFrameData.getColumnNumber(d),null,!0);this.oldValue=b}});e.on("change",".tdc-tab-no-design .tdc-innerRow-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingInnerColumns&&clearTimeout(tdcSidebarPanel.timerChangingInnerColumns);
var d=jQuery(this);tdcSidebarPanel.timerChangingInnerColumns=setTimeout(function(){var a=d.val(),c=tdcSidebar._$currentInnerRow.data("model_id"),c=tdcIFrameData.getModel(c),b=c.get("childCollection");this.oldValue="11";_.isUndefined(b)||(b=tdcIFrameData.getChildCollectionWidths(b),_.isUndefined(b)||(this.oldValue=b));tdcIFrameData.changeInnerRowModel(c,this.oldValue,a);c.getShortcodeRender(tdcIFrameData.getColumnNumber(c),null,!0);this.oldValue=a},300)});e.on("change focus",".tdc-tab-no-design .tdc-widget-sidebar-dropdown select",
function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var d=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(d,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});e.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();var d=jQuery(this);b=jQuery("#tdc-wpeditor");var a=b.children(".content"),c=d.data("mapped_parameter_name"),d=d.data("model_id"),g=tdcIFrameData.getModel(d).get("parentModel").get("attrs"),
e="tdc-three-column";if(_.has(g,"width"))switch(g.width){case "1/3":e="tdc-one-column";break;case "2/3":e="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+e+'" src="'+window.tdcAdminSettings.pluginUrl+'/includes/wpeditor.php" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+d+'" data-mapped_parameter_name="'+c+'"></iframe>');b.show();tdcWindowFrame.setWindowFrame(b)});e.on("click","#tdc-wpeditor .tdc-iframe-close-button",function(b){b.preventDefault();
jQuery("#tdc-wpeditor").hide()});e.on("click",".tdc-sidebar-delete-row",tdcRowHandlerUI.deleteHandler);e.on("click",".tdc-sidebar-delete-inner-row",tdcInnerRowHandlerUI.deleteHandler);e.on("click",".tdc-sidebar-clone-row",tdcRowHandlerUI.cloneHandler);e.on("click",".tdc-sidebar-clone-inner-row",tdcInnerRowHandlerUI.cloneHandler)},tdcImageWrapHandler:function(e){var b=jQuery(e.currentTarget);b.closest(".tdc-tab-content");window.original_send_to_editor=window.send_to_editor;wp.media.editor.open(b);
jQuery(".media-menu .media-menu-item:nth-of-type(2)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(d){var a=jQuery("img",d).attr("src"),c="";"undefined"===typeof a?(a=jQuery(d).attr("src"),c=jQuery(d).attr("class")):c=jQuery("img",d).attr("class");jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id","uuid="+tdcJobManager._getUniqueID()),
beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,d,e){"success"===d&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.removeClass("tdc-no-image-selected"),window.send_to_editor=
window.original_send_to_editor,window.tb_remove(),d="",e=b.data("model_id"),e=tdcIFrameData.getModel(e),b.hasClass("tdc-no-image-selected")||(d=c.image_id.toString()),tdcSidebarController.onUpdate(e,b.data("param_name"),"",d)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(e){var b=jQuery(e.currentTarget);e=b.closest(".tdc-property-wrap").find(".tdc-image-wrap");b.addClass("tdc-hidden-button");e.addClass("tdc-no-image-selected");jQuery.removeData(e,"image_link");e.attr("style",
"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png'");b=e.data("model_id");b=tdcIFrameData.getModel(b);tdcSidebarController.onUpdate(b,e.data("param_name"),"","")},bindPanelToModel:function(e,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==e.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){var d=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();
tdcSidebarPanel._currentBoundModel=e;for(var a=[],c=0;c<d.params.length;c++){var g=tdcSidebarPanel._defaultGroupName;_.isEmpty(d.params[c].group)||(g=d.params[c].group);a.push(g)}var a=_.uniq(a),f=g="",h=tdcSidebar.getCurrentTabId(),q,k,g=g+'<div class="tdc-tabs">';var m=k=q="";for(c=0;c<a.length;c++){f=tdcSidebarPanel._fixGroupName(a[c]);var n=tdcUtil.makeSafeForCSS(f);0===c?(q='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>",k='<a href="#" data-tab-id="td-tab-'+
n+'" title="'+f+' settings">'+f+"</a>"):_.isUndefined(h)||h!=="td-tab-"+n?m+='<a href="#" data-tab-id="td-tab-'+n+'" title="'+f+' settings">'+f+"</a>":(q=k,m+='<a href="#" data-tab-id="td-tab-'+n+'" class="tdc-tab-active" title="'+f+' settings">'+f+"</a>")}g=g+(q+m)+'</div><div class="tdc-tab-content-wrap">';m=k=q="";for(c=0;c<a.length;c++)f=tdcSidebarPanel._fixGroupName(a[c]),n=tdcUtil.makeSafeForCSS(f),f="tdc-tab-no-design","css"===n&&(f="tdc-tab-design"),0===c?(q='<div class="tdc-tab-content tdc-tab-content-visible '+
f+'" id="td-tab-'+n+'">',k='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">'):_.isUndefined(h)||h!=="td-tab-"+n?m+='<div class="tdc-tab-content '+f+'" id="td-tab-'+n+'">':(q=k,m+='<div class="tdc-tab-content tdc-tab-content-visible '+f+'" id="td-tab-'+n+'">'),m+=tdcSidebarPanel._bindGroupAndGetHtml(a[c],d,e),n=' data-model_id="'+e.cid+'" ',"vc_row"===e.attributes.tag?(m+='<div class="tdc-sidebar-row-buttons">',m+='<div class="tdc-sidebar-button tdc-sidebar-delete-row" '+n+' title="Delete the current selected Row">Delete Row</div>',
m+='<div class="tdc-sidebar-button tdc-sidebar-clone-row" '+n+' title="Make a copy of the current selected Row. The copy will appear below the current Row">Clone Row</div>',m+="</div>"):"vc_row_inner"===e.attributes.tag&&(m+='<div class="tdc-sidebar-row-buttons">',m+='<div class="tdc-sidebar-button tdc-sidebar-delete-inner-row" '+n+' title="Delete the current selected Inner Row">Delete Inner Row</div>',m+='<div class="tdc-sidebar-button tdc-sidebar-clone-inner-row" '+n+' title="Make a copy of the current selected Inner Row. The copy will appear below the current Inner Row">Clone Inner Row</div>',
m+="</div>"),m+="</div>";g=g+(q+m)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(g);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");jQuery(".tdc-breadcrumbs").show();tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===e.get("tag")){var a=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),b=e.get("childCollection");if(!_.isUndefined(b)){b=tdcIFrameData.getChildCollectionWidths(b);
_.isUndefined(b)&&(b="11");a.length?a.val(b):(a=jQuery("body .tdc-row-col-dropdown input[value='"+b+"']"),a.length&&a.attr("checked","checked"));var a=e.get("attrs");if(_.has(a,"full_width"))var d=a.full_width;_.isUndefined(d)&&(d="");c.val(d)}}})();(function(){if("vc_row_inner"===e.get("tag")){var a=jQuery("body .tdc-innerRow-col-dropdown select"),c=e.get("childCollection");if(!_.isUndefined(c)){c=tdcIFrameData.getChildCollectionWidths(c);_.isUndefined(c)&&(c="11");var b=e.get("parentModel").get("attrs"),
d="";_.has(b,"width")&&(d=b.width.replace("/",""));if(a.length)switch(a.val(c),d){case "":case "11":a.find("option[value=12_12]").hide();a.find("option[value=23_13]").show();a.find("option[value=13_23]").show();a.find("option[value=13_13_13]").show();break;case "13":a.find("option[value=12_12]").hide();a.find("option[value=23_13]").hide();a.find("option[value=13_23]").hide();a.find("option[value=13_13_13]").hide();break;case "23":a.find("option[value=12_12]").show(),a.find("option[value=23_13]").hide(),
a.find("option[value=13_23]").hide(),a.find("option[value=13_13_13]").hide()}else if(a=jQuery('body .tdc-innerRow-col-dropdown input[value="'+c+'"]'),a.length)switch(a.attr("checked","checked"),a.next("label").show(),d){case "":case "11":a.parent().find("input[value=12_12] + label").hide();a.parent().find("input[value=23_13] + label").show();a.parent().find("input[value=13_23] + label").show();a.parent().find("input[value=13_13_13] + label").show();break;case "13":a.parent().find("input[value=12_12] + label").hide();
a.parent().find("input[value=23_13] + label").hide();a.parent().find("input[value=13_23] + label").hide();a.parent().find("input[value=13_13_13] + label").hide();break;case "23":a.parent().find("input[value=12_12] + label").show(),a.parent().find("input[value=23_13] + label").hide(),a.parent().find("input[value=13_23] + label").hide(),a.parent().find("input[value=13_13_13] + label").hide()}}}})()}},_bindGroupAndGetHtml:function(e,b,d){var a="",c=window.tdcAdminSettings.mappedBlockTemplates,g=d.get("attrs");
if(_.has(g,"block_template_id")&&!_.isEmpty(g.block_template_id)){for(var g=g.block_template_id,f,h,q,k=0;k<b.params.length;k++)"custom_title"===b.params[k].param_name?f=k:"custom_url"===b.params[k].param_name?h=k:"block_template_id"===b.params[k].param_name&&(q=k);_.isUndefined(f)||(e===tdcSidebarPanel._defaultGroupName?_.isEmpty(b.params[f].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[f],d)):b.params[f].group===e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[f],d)));_.isUndefined(h)||
(e===tdcSidebarPanel._defaultGroupName?_.isEmpty(b.params[h].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[h],d)):b.params[h].group===e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[h],d)));_.isUndefined(q)||(e===tdcSidebarPanel._defaultGroupName?_.isEmpty(b.params[q].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[q],d)):b.params[q].group===e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[q],d)));for(k=0;k<c[g].params.length;k++)e===tdcSidebarPanel._defaultGroupName?
_.isEmpty(c[g].params[k].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(c[g].params[k],d)):c[g].params[k].group===e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(c[g].params[k],d));for(k=0;k<b.params.length;k++)_.isEmpty(b.params[k].td_type)&&"custom_title"!==b.params[k].param_name&&"custom_url"!==b.params[k].param_name&&"block_template_id"!==b.params[k].param_name&&(e===tdcSidebarPanel._defaultGroupName?_.isEmpty(b.params[k].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[k],d)):b.params[k].group===
e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[k],d)))}else for(k=0;k<b.params.length;k++)e===tdcSidebarPanel._defaultGroupName?_.isEmpty(b.params[k].group)&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[k],d)):b.params[k].group===e&&(a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[k],d));return a},_bindParamAndGetHtml:function(e,b){switch(e.type){case "colorpicker":return tdcSidebarPanel.addColorpicker(e,b);case "dropdown":return tdcSidebarPanel.addDropDown(e,b);case "checkbox":return tdcSidebarPanel.addCheckBox(e,
b);case "attach_image":return tdcSidebarPanel.addUploadImage(e,b);case "textfield":return tdcSidebarPanel.addTextField(e,b);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(e,b);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(e,b);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(e,b);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(e,b);default:return e.param_name+" - "+e.type+"<br>"}},
...
tdcSidebar.hideWpeditor()},_getParameterClasses:function(e){var b="tdc-property-wrap tdc-property-"+e.type;b+=" tdc-property-"+e.param_name;_.isUndefined(e["class"])||(b+=" "+e["class"]);return b},_getParameterCurrentValue:function(e,b){return _.isEmpty(b.get("attrs")[e.param_name])?"dropdown"===e.type||_.isEmpty(e.value)?"":e.value:b.get("attrs")[e.param_name]},_getParameterDomName:function(e){return"tdc-param-"+e.param_name},_getParamterDataAtts:function(e,b){var d="";if("undefined"===typeof b)return d;
d+=' data-model_id="'+b.cid+'"';"undefined"!==typeof e&&(d+=' data-param_name="'+e.param_name+'"');return d},_fixGroupName:function(e){switch(e){case "Design options":return"Css";case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return e},clearPanel:function(){tdcSidebarPanel._deletePanel()},addColorpicker:function(e,b){var d="";_.has(e,"description")&&""!==e.description&&(d=' title="'+e.description+'" ');var a="",c=_.uniqueId(),a=a+('<div class="'+tdcSidebarPanel._getParameterClasses(e)+
'">'),a=a+('<div class="tdc-property-title"><span'+d+">"+e.heading+"</span></div>"),a=a+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(e,b)+' id="'+c+'" name="'+tdcSidebarPanel._getParameterDomName(e)+'" type="text" value="'+tdcSidebarPanel._getParameterCurrentValue(e,b)+'"/>'),a=a+"</div></div>";tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery("#"+c).cs_wpColorPicker()});return a},addDropDown:function(e,b){var d=!0;_.has(e,"tdc_dropdown_images")&&""!==
e.tdc_dropdown_images&&(d=!1);for(var a="",c="",g=Object.keys(e.value),f=0;f<g.length;f++){var h=String(e.value[g[f]]),q=String(tdcSidebarPanel._getParameterCurrentValue(e,b)),k="";if(d)q===h&&(k=' selected="selected" '),c+="<option "+k+' value="'+h+'">'+g[f]+"</option>";else{0==f&&""===q&&(q=h);q===h&&(k=" checked ");var q=_.uniqueId(),m=h;if("vc_row"===b.attributes.tag||"vc_row_inner"===b.attributes.tag)m="col_"+m;c+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(e,
b)+' id="'+q+'" name="'+tdcSidebarPanel._getParameterDomName(e)+'" '+k+' value="'+h+'">';c+='<label class="tdc-property-input-radio-label" for="'+q+'" title="'+g[f]+'"><div class="'+m+'"></div></label>'}}g="";_.has(e,"description")&&""!==e.description&&(g=' title="'+e.description+'" ');a+='<div class="'+tdcSidebarPanel._getParameterClasses(e)+'">';a+='<div class="tdc-property-title"><span'+g+">"+e.heading+"</span></div>";a+='<div class="tdc-property">';d?(a+="<select "+tdcSidebarPanel._getParamterDataAtts(e,
b)+' name="'+tdcSidebarPanel._getParameterDomName(e)+'">',a=a+c+"</select>"):a+=c;return a+"</div></div>"},addCheckBox:function(e,b){var d="";_.has(e,"description")&&""!==e.description&&(d=' title="'+e.description+'" ');var a="";""!==tdcSidebarPanel._getParameterCurrentValue(e,b)&&(a=" checked ");var c=""+('<div class="'+tdcSidebarPanel._getParameterClasses(e)+'">');c+='<div class="tdc-property-title"><span'+d+">"+e.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(e,
b)+' name="'+tdcSidebarPanel._getParameterDomName(e)+'" type="checkbox" value="yes" '+a+"/>");return c+"</div></div>"},addUploadImage:function(e,b){var d="";_.has(e,"description")&&""!==e.description&&(d=' title="'+e.description+'" ');var a=""+('<div class="'+tdcSidebarPanel._getParameterClasses(e)+'">');a+='<div class="tdc-property-title"><span'+d+">"+e.heading+"</span></div>";a=a+'<div class="tdc-property">'+('<div class="tdc-image-wrap tdc-no-image-selected" '+tdcSidebarPanel._getParamterDataAtts(e,
b)+" style=\"background-image: url('"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png')\">");a+='</div><a class="tdc-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-image-wrap").each(function(a,d){var c=jQuery(d);if(!c.parent().parent(".tdc-bg-upload").length&&e.param_name===c.data("param_name")){var g=tdcSidebarPanel._getParameterCurrentValue(e,b);""!==g&&jQuery.ajax({timeout:1E4,type:"POST",
url:tdcUtil.getRestEndPoint("td-composer/get_image_url","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:g,action:"tdc_ajax_get_image_url"}}).done(function(a,b,d){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),c.data("image_link",a.image_url),c.data("image_id",
g),c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,c,b){})}})});return a},addTextArea:function(){},addTextField:function(e,b){var d="",a="";if(_.has(e,"description")&&""!==e.description){var c=jQuery("<div>"+e.description+"</div>");e.description===c.text()?d=' title="'+e.description+'" ':a='<div class="tdc-description">'+e.description+"</div>"}c=""+('<div class="'+tdcSidebarPanel._getParameterClasses(e)+'">');c+='<div class="tdc-property-title"><span'+
d+">"+e.heading+"</span></div>";c=c+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(e,b)+' name="'+tdcSidebarPanel._getParameterDomName(e)+'" type="text" value="'+tdcSidebarPanel._getParameterCurrentValue(e,b)+'"/>');return c=c+a+"</div></div>"},addTextAreaHtml:function(e,b){_.has(e,"description");var d='<a href="#" class="tdc-open-wpeditor" data-model_id="'+b.cid+'" data-mapped_parameter_name="'+e.param_name+'">Edit Content</a>';tdcSidebarPanel._hook.addAction("panel_rendered",
function(){});return d},addTextAreaRawHtml:function(e,b){var d=_.uniqueId("tdc_textarea_"),a="";_.has(e,"description")&&""!==e.description&&(a=' title="'+e.description+'" ');var c=""+('<div class="'+tdcSidebarPanel._getParameterClasses(e)+'">');c+='<div class="tdc-property-title"><span'+a+">"+e.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<textarea id="'+d+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(e,b)+">"+tdcSidebarPanel._getParameterCurrentValue(e,b)+"</textarea>");
c+="</div></div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(e,b)}}).done(function(a,c,b){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,
!0,!1):jQuery("#"+d).html(a.parsed_content).show())}).fail(function(a,c,b){});jQuery("body").on("keyup","#"+d,function(a){a=jQuery(a.target);var c=tdcIFrameData.getModel(a.data("model_id")),b=window.btoa(encodeURIComponent(a.val()));tdcSidebarController.onUpdate(c,a.data("param_name"),b,b)});return c},addSeparatorHorizontal:function(e,b){return""+('<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(e)+'"></div>')}}})();var tdcSidebar;
...
e.isUndefined(tdcSidebar._$currentInnerColumn)||tdcMaskUI.setCurrentContainer(tdcSidebar._$currentInnerColumn)}).mouseleave(function(b){tdcMaskUI.hide()});f(".tdc-sidebar-element").each(function(b,a){tdcSidebar._bindElement(f(a))});tdcSidebar.$_sidebarClosePage.click(function(d){tdcMain.getContentModified()?tdConfirm.showModal("Close tagDiv Composer",tdcSidebar,function(){window.onbeforeunload=null;window.location=window.tdcAdminSettings.editPostUrl;tb_remove()},b,"Unsaved content. Still want to close tagDiv Composer?"):
tdConfirm.showModal("Close tagDiv Composer",tdcSidebar,function(){window.onbeforeunload=null;window.location=window.tdcAdminSettings.editPostUrl;tb_remove()},b,"Are you sure you want to close tagDiv Composer?")});"1"===window.localStorage.getItem("tdc_live_iframe_wrapper_inline")&&(tdcMain.setSidebarInline(),tdcSidebar.$_sidebar.addClass("tdc-sidebar-inline"),tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-inline").removeClass("tdc-live-iframe-wrapper-full"));tdcSidebar.$_sidebarBullet.click(function(b){tdcSidebar.$_sidebar.toggleClass("tdc-sidebar-inline");
...
window.tdcAdminSettings.mappedShortcodes[l].tdc_category===window.tdcAdminSettings.mappedShortcodes[a].tdc_category){var h="";l===a&&(h="tdc-selected-option");g+='<li class="'+h+'" data-block_type="'+window.tdcAdminSettings.mappedShortcodes[l].base+'"><div class="tdc-element-ico tdc-ico-'+window.tdcAdminSettings.mappedShortcodes[l].base+'"></div><div class="tdc-element-id">'+window.tdcAdminSettings.mappedShortcodes[l].name+"</div></li>"}""!==g?(g="<ul>"+g+"</ul>",tdcSidebar.$_currentElementHead.addClass("tdc-block-selection")):
...
delete tdcCssEditor._currentCssSettings[tdcCssEditor._currentViewportSettings.name][l];c.data("no_value",0);var h={isInherited:!1},l=tdcCssEditor._getSettingsProperty(l,b,h);h.isInherited?(a.addClass(tdcCssEditor._INHERITED_CSS_CLASS),d.hide()):(a.removeClass(tdcCssEditor._INHERITED_CSS_CLASS),d.show());e.isUndefined(l)?(c.val(""),d.hide(),tdcCssEditor._updateData(c),tdcCssEditor._checkDefaultColor(c)):(c.val(""),c.attr("placeholder",l),g.attr("style","background-color: "+tdcCssEditor._getRgba(l)),
...
_changeTextInput:function(b){var a=f(b.currentTarget),c=a.parent(),d=a;c.hasClass("tdc-box-margin")||c.hasClass("tdc-box-border")||c.hasClass("tdc-box-padding")||(d=a.closest(".tdc-property-wrap"));var c=a.val(),l=1;a.hasClass("tdc-css-opacity")&&(l=.01);var h=NaN;switch(b.type){case "keyup":switch(b.keyCode){case 38:f.isNumeric(c)&&(h=parseFloat(c)+l);break;case 40:f.isNumeric(c)&&(h=parseFloat(c)-l)}break;case "mousewheel":f.isNumeric(c)&&(h=0<b.originalEvent.deltaY?parseFloat(c)-l:parseFloat(c)+
l)}e.isNaN(h)||(1>l&&(h=h.toFixed(2)),a.val(h));tdcCssEditor._updateData(a);c=d.data("tdc-for");b={isInherited:!1};c=tdcCssEditor._getSettingsProperty(c,"",b);b.isInherited?(a.attr("placeholder",c),a.val(""),d.addClass(tdcCssEditor._INHERITED_CSS_CLASS)):d.removeClass(tdcCssEditor._INHERITED_CSS_CLASS)},_keydownTextInput:function(b){if(38===b.keyCode||40===b.keyCode)return!1},_focusTextInput:function(b){b=f(b.currentTarget);for(var a=b.closest(".tdc-property-wrap"),c=a[0].classList,d=0;d<c.length;d++)c[d].startsWith("tdc-el-")&&
...
b,new tdcNotice.notice(l.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){f(".tdc-css-image-wrap").each(function(a,c){var d=f(c),g=d.closest(".tdc-property-wrap"),h=g.find(".tdc-css-image-remove"),l=g.find(".tdc-inherit-image"),p={isInherited:!1},u=tdcCssEditor._getSettingsProperty("background-image",b,p);p.isInherited?g.addClass(tdcCssEditor._INHERITED_CSS_CLASS):g.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);e.isUndefined(u)?(h.addClass("tdc-hidden-button"),l.hide()):
("no_value"===u?h.addClass("tdc-hidden-button"):(h.removeClass("tdc-hidden-button"),d.attr("style",'background-image: url("'+u+'")')),"all"!==tdcCssEditor._currentViewportSettings.name&&l.show());d.data("image_link",u)});f(".tdc-inherit").each(function(a,c){var d=f(c),g=d.closest(".tdc-property-wrap");if("all"===tdcCssEditor._currentViewportSettings.name||g.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))d.hide();else{var h=g.data("tdc-for"),g={isInherited:!1},h=tdcCssEditor._getSettingsProperty(h,b,
g);g.isInherited?d.hide():e.isUndefined(h)||d.show()}})});var c=a="",g="";d="";switch(tdcCssEditor._currentViewportSettings.name){case "all":a="selected";break;case "landscape":c="selected";break;case "portrait":g="selected";break;case "phone":d="selected"}a='<div class="tdc-responsive-buttons">'+('<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>')+('<div class="tdc-responsive-tablet-landscape '+c+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>')+
...
"":c[2]}a=a.toLowerCase();a=a.replace(/!important|px/g,"");return a.trim()},_getDataNoValue:function(b){var a="";"no_value"===b&&(a=' data-no_value="1" ');return a},_generateEditorResponsiveContent:function(){function d(){return q={isInherited:!1}}function a(a){return"all"!==tdcCssEditor._currentViewportSettings.name?'placeholder="'+a+'"':""}function c(){return q.isInherited?" "+tdcCssEditor._INHERITED_CSS_CLASS:""}function g(a,b){var g=tdcCssEditor._getSettingsProperty(a,b,d()),f="-",k="";q.isInherited&&
(f=g,g="");e.isUndefined(h)||"margin-left"!==a&&"margin-right"!==a||(k=h.get("tag"),k="vc_column"===k||"vc_column_inner"===k?" "+tdcCssEditor._INACTIVE_CSS_CLASS:"");return'<input data-tdc-for="'+a+'" name="" type="text" value="'+g+'" class="tdc-css-box-input tdc-css-box-input-'+a+c()+k+'" title="Css '+a+'" placeholder="'+f+'" '+tdcSidebarPanel._getParamterDataAtts(l,h)+"/>"}tdcSidebarPanel._hook.removeAction("panel_css");var l=tdcCssEditor._mappedParameter,h=tdcCssEditor._model,q={isInherited:!1};
var k='<div class="tdc-responsiveness">'+('<div class="'+tdcSidebarPanel._getParameterClasses(l)+'">');k=k+'<div class="tdc-box-margin"><div class="tdc-margin-label">Margin</div>'+g("margin-top","");k+=g("margin-right","");k+=g("margin-bottom","");k+=g("margin-left","");k=k+'<div class="tdc-box-border"><div class="tdc-border-label">Border</div>'+g("border-top-width","");k+=g("border-right-width","");k+=g("border-bottom-width","");k+=g("border-left-width","");k=k+'<div class="tdc-box-padding"><div class="tdc-padding-label">Padding</div>'+
g("padding-top","");k+=g("padding-right","");k+=g("padding-bottom","");k+=g("padding-left","");k+="</div></div></div></div>";var m=tdcCssEditor._getSettingsProperty("border-style",b,d());k+='<div class="tdc-property-wrap tdc-border-style tdc-dropdown-big'+c()+'" data-tdc-for="border-style">';k=k+'<div class="tdc-property-title"><span title="Css border-style">Border style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+('<select class="tdc-css-border-style" '+
tdcSidebarPanel._getParamterDataAtts(l,h)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"solid",display:"Solid"},{value:"dotted",display:"Dotted"},{value:"dashed",display:"Dashed"},{value:"none",display:"None"},{value:"hidden",display:"Hidden"},{value:"double",display:"Double"},{value:"groove",display:"Groove"},{value:"ridge",display:"Ridge"},{value:"inset",display:"Inset"},{value:"outset",display:"Outset"},{value:"initial",display:"Initial"},{value:"inherit",display:"Inherit"}],m);
k+="</select></div></div>";var n=e.uniqueId(),m=tdcCssEditor._getSettingsProperty("border-color","",d()),p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+c()+'" data-tdc-for="border-color">';k=k+'<div class="tdc-property-title"><span title="Css border-color">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(l,
h)+tdcCssEditor._getDataNoValue(m)+' data-default_value="#888888" id="'+n+'" name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(f("#"+n))});m=tdcCssEditor._getSettingsProperty("border-radius","",d());p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+c()+'" data-tdc-for="border-radius">';k=k+'<div class="tdc-property-title"><span title="Css border-radius">Border radius</span></div><div class="tdc-property">'+
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(l,h)+' name="" type="text" '+a(p)+' value="'+m+'"/>');k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator "></div>';var u=e.uniqueId(),m=tdcCssEditor._getSettingsProperty("background-color","",d()),p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+c()+'" data-tdc-for="background-color">';
k=k+'<div class="tdc-property-title"><span title="Css background-color">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(l,h)+tdcCssEditor._getDataNoValue(m)+' id="'+u+'" name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(f("#"+u))});tdcCssEditor._getSettingsProperty("background-image",
b,d());k+='<div class="tdc-property-wrap tdc-property-attach_image'+c()+'">';k=k+'<div class="tdc-property-title"><span title="Css background-image">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property">'+('<div class="tdc-css-bg-image tdc-css-image-wrap " '+tdcSidebarPanel._getParamterDataAtts(l,h)+" style=\"background-image: url( '"+window.tdcAdminSettings.pluginUrl+"/assets/images/sidebar/no_img.png' )\"></div>");
k+='<a class="tdc-css-image-remove tdc-hidden-button" href="#" >Remove</a></div></div>';m=tdcCssEditor._getSettingsProperty("background-style",b,d());k+='<div class="tdc-property-wrap tdc-bg-style tdc-dropdown-big'+c()+'" data-tdc-for="background-style">';k=k+'<div class="tdc-property-title"><span title="Css background-size & background-repeat">Background style<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+('<select class="tdc-css-bg-style" '+
tdcSidebarPanel._getParamterDataAtts(l,h)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"cover",display:"Cover"},{value:"contain",display:"Contain"},{value:"no-repeat",display:"No repeat"},{value:"repeat",display:"Repeat"}],m);k+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("background-position",b,d());k+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+c()+'" data-tdc-for="background-position">';k=k+'<div class="tdc-property-title"><span title="Css background-position">Background position<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property">'+
('<select class="tdc-css-bg-position" '+tdcSidebarPanel._getParamterDataAtts(l,h)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"center top",display:"Center Top"},{value:"center center",display:"Center Center"},{value:"center bottom",display:"Center Bottom"},{value:"left top",display:"Left Top"},{value:"left center",display:"Left Center"},{value:"left bottom",display:"Left Bottom"},{value:"right top",display:"Right Top"},{value:"right center",display:"Right Center"},{value:"right bottom",
display:"Right Bottom"}],m);k+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",d());p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+c()+'" data-tdc-for="opacity">';k=k+'<div class="tdc-property-title"><span title="Css background-image opacity">Background opacity</span></div><div class="tdc-property">'+('<input class="tdc-css-opacity" '+tdcSidebarPanel._getParamterDataAtts(l,h)+' name="" type="text" '+a(p)+' value="'+m+'"/>');
k+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>';var v=e.uniqueId(),m=tdcCssEditor._getSettingsProperty("color-1-overlay","",d()),p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-1-overlay'+c()+'" data-tdc-for="color-1-overlay">';k=k+'<div class="tdc-property-title"><span title="Css gradient color From">Color 1 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(l,h)+tdcCssEditor._getDataNoValue(m)+' id="'+v+'" name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(f("#"+v))});var w=e.uniqueId(),m=tdcCssEditor._getSettingsProperty("color-2-overlay","",d()),p="";q.isInherited&&(p=m,m="");k+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+c()+'" data-tdc-for="color-2-overlay">';
k=k+'<div class="tdc-property-title"><span  title="Css gradient color To">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property">'+('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(l,h)+tdcCssEditor._getDataNoValue(m)+' id="'+w+'" name="" type="text" '+a(p)+' value="'+m+'"/>');k+="</div></div>";tdcSidebarPanel._hook.addAction("panel_css",function(){tdcCssEditor._CsWpColorPicker(f("#"+w))});
k=k+'<div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div>'+('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(l,h)+' title="Clear all tab css settings">Clear CSS settings</div>');return k+"</div>"},_getAvailableViewportSetting:function(b,a,c){if("undefined"!==typeof tdcCssEditor._currentCssSettings){var d;switch(b){case "all":"undefined"!==typeof tdcCssEditor._currentCssSettings[b]&&(d="all");break;
...
a,c){var d;"undefined"===typeof c&&(c={isInherited:!1});"undefined"!==typeof tdcCssEditor._currentCssSettings&&(d=tdcCssEditor._getAvailableViewportSetting(tdcCssEditor._currentViewportSettings.name,b,c));"undefined"===typeof d&&"undefined"!==typeof a&&(d=a);return d},_generateDropdownOptions:function(b,a,c){for(var d=[],f,h=!1,q=0,k=0;k<b.length;k++)e.isUndefined(c)||c!==b[k].value||(q=k),f="",e.isUndefined(a)||a!==b[k].value||(f='selected="selected"',h=!0),d.push("<option "+f+' value="'+b[k].value+
'">'+b[k].display+"</option>");h||(d[q]='<option selected="selected" value="'+b[q].value+'">'+b[q].display+"</option>");return d.join("")},_generateCssAttValue:function(b){var a={},c=b.find(".tdc-css-box-input-margin-top").val().trim(),d=b.find(".tdc-css-box-input-margin-right").val().trim(),f=b.find(".tdc-css-box-input-margin-bottom").val().trim(),h=b.find(".tdc-css-box-input-margin-left").val().trim(),q=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),
...
d);""!==f&&(a["margin-bottom"]=f);""!==h&&(a["margin-left"]=h);""!==q&&(a["border-top-width"]=q);""!==k&&(a["border-right-width"]=k);""!==m&&(a["border-bottom-width"]=m);""!==n&&(a["border-left-width"]=n);""!==p&&(a["padding-top"]=p);""!==u&&(a["padding-right"]=u);""!==v&&(a["padding-bottom"]=v);""!==w&&(a["padding-left"]=w);c=b.find(".tdc-css-border-style");d=c.val().trim();""===d||c.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=d);c=b.find(".tdc-css-border-color");
...
e=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(d.find(".wp-picker-holder")),q=e.find(".cs-alpha-slider"),k=e.find(".cs-alpha-text"),m=e.find(".cs-alpha-slider-offset");q.slider({slide:function(b,d){var e=parseFloat(d.value/100);c._color._alpha=e;a.wpColorPicker("color",c._color.toString());k.text(1>e?e:"")},create:function(){var g=parseFloat(b.alpha/100);k.text(1>g?g:"");m.css("background-color",
b.value);d.on("click",".wp-picker-clear",function(){c._color._alpha=1;k.text("");q.slider("option","value",100).trigger("slide")});d.on("click",".wp-picker-default",function(){var b=f.cs_ParseColorValue(a.data("default-color")),d=parseFloat(b.alpha/100);c._color._alpha=d;k.text(1>d?d:"");q.slider("option","value",b.alpha).trigger("slide")});d.on("click",".wp-color-result",function(a){e.toggle()});f("body").on("click.wpcolorpicker",function(){e.hide()})},value:b.alpha,step:1,min:1,max:100})}})}else a.wpColorPicker({clear:function(){a.trigger("keyup")},
...
f.isUndefined(tdcLivePanel._iframeSrc)&&(tdcLivePanel._iframeSrc=b.attr("src"));var d="uid_"+Math.floor(1E4*Math.random()+1)+"_"+Math.floor(100*Math.random()+1),a=jQuery('<iframe id="tdc-live-iframe-temp" name="'+d+'" scrolling="auto" src="about:blank" style="width: 100%; height: 100%" class="tdc-live-iframe-temp"></iframe>');a.insertAfter(b);a.load(function(){jQuery(a.get(0).contentWindow).scrollTop(jQuery(b.get(0).contentWindow).scrollTop())});tdcLivePanel.$panel.attr("target",d);tdcLivePanel.$panel.attr("action",
tdcLivePanel._iframeSrc);tdcLivePanel.$tdcIframeCover.show();tdcLivePanel.$tdcIframeCover.addClass("tdc-iframe-cover-show");d={error:e,getShortcode:""};tdcIFrameData.getShortcodeFromData(d);f.isUndefined(d.error)||tdcDebug.log(d.error);f.isUndefined(d.getShortcode)||(tdcLivePanel.$tdcContent.val(d.getShortcode),window.tdcPostSettings.postContent=d.getShortcode);tdcLivePanel.$tdcAction.val("preview");tdcLivePanel.$tdcCustomized.val(JSON.stringify(window.tdcAdminSettings.customized));tdcLivePanel.$panel.submit()}};
