...
c.each(tdcInit.$catslist,function(a,c,f){a=b(a);a.is(":checked")&&(tdcInit.catslistValue+=a.val()+",")}),tdcInit._url=window.tdcAdminSettings.adminUrl+"post.php?post_id="+tdcInit.$postId.val()+"&td_action=tdc","page"===tdcInit.$postType.val()&&!0===window.tdcAdminSettings.hasUserRights&&b('<div class="tdc-panel-button"><div class="tdc-panel-icon"></div><div class="tdc-panel-link"><a onclick="return tdcInit.savePost( event )" href="'+tdcInit._url+'">TagDiv Composer</a></div></div>').insertAfter("div#titlediv"))},
