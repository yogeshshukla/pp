...
class The_NewsMag_Random_Posts_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				...
				array('description' => esc_html__('Displays the random posts from your site.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-random-posts-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_Tabbed_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				...
				array('description' => esc_html__('Displays the popular posts, recent posts and the recent comments in the tabs.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-tabbed-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_Posts_Slider_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				...
				array('description' => esc_html__('Displays the latest posts or posts from certain category chosen to be used as the slider.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-posts-slider-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_Posts_Grid_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				'the_newsmag_posts_grid_widget', esc_html__('TNM: Posts Grid Widget', 'the-newsmag'), // Name of the widget
				array('description' => esc_html__('Displays the latest posts or posts from certain category chosen to be used in beside the slider area.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-posts-grid-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_Posts_Two_Column_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				'the_newsmag_posts_two_column_widget', esc_html__('TNM: Posts Two Column Widget', 'the-newsmag'), // Name of the widget
				array('description' => esc_html__('Displays the latest posts or posts from certain category chosen to display the posts in double column.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-two-column-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_Posts_Extended_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				'the_newsmag_posts_extended_widget', esc_html__('TNM: Posts Extended Widget', 'the-newsmag'), // Name of the widget
				array('description' => esc_html__('Displays the latest posts or posts from certain category chosen to display the posts and its excerpt.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-posts-extended-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
...
class The_NewsMag_728x90_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				'the_newsmag_728x90_widget', esc_html__('TNM: 728 x 90 Advertisement Widget', 'the-newsmag'), // Name of the widget
				array('description' => esc_html__('Add the required 728 x 90 advertisement in your site with the help of the image.', 'the-newsmag'), 'classname' => 'widget-entry-meta the-newsmag-728x90-widget clear') // Arguments of the widget, here it is provided with the description
		);
	}
